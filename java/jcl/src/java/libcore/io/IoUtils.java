...
public final class IoUtils {
	...
	/**
	 * Closes 'closeable', ignoring any exceptions. Does nothing if 'closeable'
	 * is null.
	 */
	...
	/**
	 * Returns the int file descriptor from within the given FileDescriptor
	 * 'fd'.
	 */
	 ...
	 * fds[1] is the write end of the pipe. Throws an appropriate IOException on
	 * failure.
	 */
	public static native void pipe(int[] fds) throws IOException;

	/**
	 * Sets the int file descriptor within the given FileDescriptor 'fd' to
	 * 'newValue'.
	 */
	public static native void setFd(FileDescriptor fd, int newValue);

	/**
	 * Sets 'fd' to be blocking or non-blocking, according to the state of
	 * 'blocking'.
	 */
	public static native void setBlocking(FileDescriptor fd, boolean blocking)
			throws IOException;
}
