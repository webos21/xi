 ...
 * authenticator which extends {@code Authenticator} by
 * {@code setDefault(Authenticator a)}. Then it should override
 * {@code getPasswordAuthentication()} which dictates how the authentication
 * info is obtained. Usually, it prompts the user for the required input.
 * 
 * @see #setDefault
...
public abstract class Authenticator {
	 ...
	 * a security manager set then the caller must have the appropriate
	 * {@code NetPermission}.
	 * 
	 * @param a
	...
	/**
	 * Returns the type of this request, it can be {@code PROXY} or
	 * {@code SERVER}.
	 * 
