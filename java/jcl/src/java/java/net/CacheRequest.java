 ...
 * current store operation by calling the method {@code abort}. If an
 * {@code IOException} occurs while reading the response or writing data to the
 * cache, the current cache store operation is abandoned.
 * 
 * @see ResponseCache
 */
