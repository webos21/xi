...
public interface CookieStore {
	 ...
	 * domain and path attribute will show cradleland. If there is an associated
	 * URI and no domain and path attribute are speicifed for the cookie, the
	 * given URI will indicate where this cookie comes from.
	 * 
	...
	/**
	 * Retrieves cookies that match the specified URI. Return not expired
	 * cookies. For every outgoing HTTP request, this method will be called.
	 * 
	 * @param uri
