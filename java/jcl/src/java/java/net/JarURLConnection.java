...
/**
 * This class establishes a connection to a {@code jar:} URL using the
 * {@code JAR} protocol. A {@code JarURLConnection} instance can refer to either
 * a JAR archive file or to an entry of such a file. {@code jar:} URLs are
 * specified as follows: <i>jar:{archive-url}!/{entry}</i> where "!/" is called
 * a separator. This separator is important to determine if an archive or an
 * entry of an archive is referred.
 * <p>
 * Examples:
 * <li>Archive: {@code jar:http://www.example.com/applets/archive.jar!/}</li>
 * <li>File Entry:
 * {@code jar:http://www.example.com/applets/archive.jar!/test.class}</li>
 * <li>Directory Entry:
 * {@code jar:http://www.example.com/applets/archive.jar!/applets/}</li>
 */
public abstract class JarURLConnection extends URLConnection {
	...
	/**
	 * Returns all attributes of the {@code JarEntry} referenced by this
	...
	/**
	 * Gets the {@code JarEntry} object of the entry referenced by this
	 * {@code JarURLConnection}.
	 * 
	...
	/**
	 * Gets the {@code JarFile} object referenced by this
	 * {@code JarURLConnection}.
	 * 
	 ...
	 * {@code JarURLConnection}. If this instance refers to a JAR-file rather
	 * than a JAR-file entry, {@code null} will be returned.
	 * 
