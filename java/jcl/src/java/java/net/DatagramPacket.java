...
public final class DatagramPacket {
	 ...
	 * {@code length} bytes from the byte array position {@code offset} are
	 * sent.
	 * 
	 * @param data
	...
	/**
	 * An alternative to {@link #setLength(int)}, that doesn't reset the
	 * {@link #capacity} field.
	 * 
	 * @param len
	 *            the length of this datagram packet
	...
	public synchronized void setSocketAddress(SocketAddress sockAddr) {
		if (!(sockAddr instanceof InetSocketAddress)) {
			throw new IllegalArgumentException(
					"Socket address not an InetSocketAddress: "
