 ...
 * options. It is implemented by the classes {@code SocketImpl} and
 * {@code DatagramSocketImpl}.
 * 
 * @see SocketImpl
...
public interface SocketOptions {
	 ...
	 * 65535}. (Larger timeouts will be treated as 65535s timeouts; roughly 18
	 * hours.)
	 */
	public static final int SO_LINGER = 128;

	/**
	 * Timeout for blocking accept or read/receive operations (but not
	 * write/send operations). The argument value is specified in milliseconds,
	 * with 0 meaning no timeout and negative values not allowed. An
	 * {@code InterruptedIOException} is thrown if this timeout expires.
	 */
	 ...
	 * the IP header. This may be ignored by the underlying OS. Values must be
	 * between 0 and 255 inclusive. See <a
	 * href="http://www.ietf.org/rfc/rfc1349.txt">RFC 1349</a> for more
	 * information.
	 */
