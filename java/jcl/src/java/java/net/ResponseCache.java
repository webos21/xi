 ...
 * <p>
 * The system's default cache can be set using {@link #setDefault}. If
 * {@link URLConnection#getUseCaches} returns true, {@code URLConnection} will
 * use the default response cache, if one has been set.
 * <p>
 * Although {@code URLConnection} will always call {@link #put}, the specific
 * {@code ResponseCache} implementation gets to decide what will actually be
...
public abstract class ResponseCache {
	...
	/**
	 * Sets the system's default response cache. Use null to remove the response
	 * cache.
	 */
	 ...
	 * @return the {@code CacheResponse} object if the request is available in
	 *         the cache or {@code null} otherwise.
	 * @throws IOException
