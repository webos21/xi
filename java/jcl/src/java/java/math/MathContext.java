...
public final class MathContext implements Serializable {
	 ...
	 * {@code 'p','r','e','c','i','s','i','o','n','='}. It's used to improve the
	...
	/**
	 * An array of {@code char} containing:
	 * {@code 'r','o','u','n','d','i','n','g','M','o','d','e','='}. It's used to
	 ...
	 * "precision=&lt;precision&gt; roundingMode=&lt;roundingMode&gt;" This is
	 * the same form as the one returned by the {@link #toString} method.
	 * 
	 * @param val
     ...
     * } where {@code &lt;precision&gt;} is an integer describing the number of
	 * digits used for operations and {@code &lt;roundingMode&gt;} is the string
