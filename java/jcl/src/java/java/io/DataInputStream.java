 ...
 * 64-bit double, byte strings, and strings encoded in {@link DataInput modified
 * UTF-8}.
 * 
...
public class DataInputStream extends FilterInputStream implements DataInput {
	...
	/**
	 * Constructs a new DataInputStream on the InputStream {@code in}. All reads
	 * are then filtered through this stream. Note that data read by this stream
	 * is not in a human readable format and was most likely created by a
	 * DataOutputStream.
	 * 
	 * <p>
	 * <strong>Warning:</strong> passing a null source creates an invalid
	 ...
	 * {@code buffer} starting at the position {@code offset}. This method
	 * blocks until {@code length} bytes have been read. If {@code length} is
	 * zero, then this method returns without reading any bytes.
	 * 
	 * @param buffer
	...
	private static String decodeUTF(int utfSize, DataInput in)
			throws IOException {
