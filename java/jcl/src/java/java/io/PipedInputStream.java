...
public class PipedInputStream extends InputStream {
	...
	/**
	 * Constructs a new {@code PipedInputStream} connected to the given
	 * {@code PipedOutputStream}, with the given buffer size. Any data written
	 * to the output stream can be read from this input stream.
	 * 
	 * @param out
	 *            the {@code PipedOutputStream} to connect to.
	 * @param pipeSize
	 *            the size of the buffer in bytes.
	 * @throws IOException
	 ...
	 * 
	 * <p>
	 * Unlike most streams, {@code PipedInputStream} returns 0 rather than
	 * throwing {@code IOException} if the stream has been closed. Unconnected
	 * and broken pipes also return 0.
	 * 
	 * @throws IOException
	 *             if an I/O error occurs
	 */
	 ...
	 * @param offset
	 *            the initial position in {@code bytes} to store the bytes read
	 *            from this stream.
	 * @param count
