 ...
 * and different comment styles. The class can be used for limited processing of
 * source code of programming languages like Java, although it is nowhere near a
 * full parser.
 */
public class StreamTokenizer {
	 ...
	 * <li> {@code TT_EOL} - the end of line has been reached. Depends on whether
	 * {@code eolIsSignificant} is {@code true}.</li>
