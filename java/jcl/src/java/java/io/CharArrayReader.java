...
public class CharArrayReader extends Reader {
	...
	public CharArrayReader(char[] buf, int offset, int length) {
		 ...
		 * compatible with the broken spec, we must also test whether (offset +
		 * length) overflows.
		 */
	 ...
	 * stores them at {@code offset} in the character array {@code buf}. Returns
	 * the number of characters actually read or -1 if the end of reader was
	 * encountered.
	 * 
	 * @param buffer
