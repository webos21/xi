...
public abstract class FilterReader extends Reader {
	...
	/**
	 * Reads at most {@code count} characters from the filtered reader and
	 ...
	 * were read and the end of the filtered reader was encountered.
	 * 
	 * @param buffer
	...
	/**
	 * Skips {@code count} characters in this reader. Subsequent {@code read()}
	 * 's will not return these characters unless {@code reset()} is used. The
