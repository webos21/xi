...
class EmulatedFieldsForLoading extends ObjectInputStream.GetField {
	...
	/**
	 * Return a boolean indicating if the field named <code>name</code> has been
	 * assigned a value explicitly (false) or if it still holds a default value
	 * for the type (true) because it hasn't been assigned to yet.
	 * 
	 * @param name
	...
	/**
	 * Find and return the int value of a given field named <code>name</code> in
	 ...
	 * <code>name</code> in the receiver. If the field has not been assigned any
	 * value yet, the default value <code>defaultValue</code> is returned
	 * instead.
	 * 
	 * @param name
	 *            A String, the name of the field to find
