...
public abstract interface ObjectStreamConstants {
	...
	/**
	 * Tag to mark a long block of data. The long following this tag indicates
	...
	/**
	 * Bit mask for the {@code flag} field in ObjectStreamClass. Indicates that
	 * a serializable class has its own {@code writeObject} method.
	 */
	public static final byte SC_WRITE_METHOD = 0x01; // If SC_SERIALIZABLE

	/**
	 * Bit mask for the {@code flag} field in ObjectStreamClass. Indicates that
	 * a class is serializable.
	 */
	public static final byte SC_SERIALIZABLE = 0x02;

	/**
	 * Bit mask for the {@code flag} field in ObjectStreamClass. Indicates that
	 * a class is externalizable.
	 */
	public static final byte SC_EXTERNALIZABLE = 0x04;

	/**
	 * Bit mask for the {@code flag} field in ObjectStreamClass. Indicates that
	 * an externalizable class is written in block data mode.
	 */
