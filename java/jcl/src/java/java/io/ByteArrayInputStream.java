...
public class ByteArrayInputStream extends InputStream {
	...
	/**
	 * Reads at most {@code len} bytes from this stream and stores them in byte
	 * array {@code b} starting at {@code offset}. This implementation reads
	 * bytes from the source byte array.
	 * 
	 * @param buffer
	 ...
	 *             {@code offset + length} is greater than the size of {@code b}
	 *             .
