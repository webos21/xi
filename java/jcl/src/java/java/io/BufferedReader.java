...
public class BufferedReader extends Reader {
	...
	/**
	 * Constructs a new {@code BufferedReader}, providing {@code in} with a
	 * buffer of 8192 characters.
	 * 
	 * @param in
	...
	/**
	 * Constructs a new {@code BufferedReader}, providing {@code in} with
	 * {@code size} characters of buffer.
	 * 
	 * @param in
	 *            the {@code InputStream} the buffer reads from.
	 * @param size
	...
	/**
	 * Skips {@code amount} characters in this reader. Subsequent {@code read()}
	 * s will not return these characters unless {@code reset()} is used.
	 * Skipping characters may invalidate a mark if {@code markLimit} is
	 * surpassed.
	 * 
	 * @param amount
