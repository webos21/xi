...
public class StringWriter extends Writer {
	 ...
	 * {@code StringBuffer} is also the {@code lock} used to synchronize access
	 * to this writer.
	 */
	public StringWriter() {
		super();
	...
	/**
	 * Constructs a new {@code StringWriter} which has a {@link StringBuffer}
	 * allocated with a size of {@code initialSize} characters. The
	 * {@code StringBuffer} is also the {@code lock} used to synchronize access
	 * to this writer.
	 * 
	 * @param initialSize
	...
	/**
	 * Calling this method has no effect. In contrast to most {@code Writer}
	 * subclasses, the other methods in {@code StringWriter} do not throw an
	 * {@code IOException} if {@code close()} has been called.
	 * 
	 * @throws IOException
	 ...
	 * {@code offset} to this writer's {@code StringBuffer}.
	 * 
	 * @param str
	 *            the non-null string containing the characters to write.
	 * @param offset
	...
	/**
	 * Appends the character sequence {@code csq} to this writer's
	 * {@code StringBuffer}. This method works the same way as
	 * {@code StringWriter.write(csq.toString())}. If {@code csq} is
	 * {@code null}, then the string "null" is written to the target stream.
	 * 
	 * @param csq
	 ...
	 * writer's {@code StringBuffer}. This method works the same way as
	 * {@code StringWriter.writer(csq.subsequence(start, end).toString())}. If
