...
/**
 * A specialized {@link Reader} that reads characters from a {@code String} in a
 * sequential manner.
 * 
 * @see StringWriter
 */
public class StringReader extends Reader {
	...
	/**
	 * Moves {@code ns} characters in the source string. Unlike the
	 * {@link Reader#skip(long) overridden method}, this method may skip
	 * negative skip distances: this rewinds the input so that characters may be
	 * read again. When the end of the source string has been reached, the input
	 * cannot be rewound.
	 * 
	 * @param ns
	 ...
	 *         by the number of characters already read and above by the number
	 *         of characters remaining:<br> {@code -(num chars already
