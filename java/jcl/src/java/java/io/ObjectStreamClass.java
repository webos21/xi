...
public class ObjectStreamClass implements Serializable {
	...
	private static ObjectStreamClass createClassDesc(Class<?> cl) {
		...
		if (externalizable) {
			...
			flags |= ObjectStreamConstants.SC_BLOCK_DATA; // use protocol
															// version 2 by
															// default
	...
	/**
	 * Compute and return the Serial Version UID of the class {@code cl}. The
	 * value is computed based on the class name, superclass chain, field names,
	 * method names, modifiers, etc.
	 * 
	 * @param cl
				...
				if (Modifier.isStatic(modifiers) && Modifier.isFinal(modifiers)) {
					if (UID_FIELD_NAME.equals(field.getName())) {
						...
						try {
							...
							throw new RuntimeException("Error fetching SUID: "
									+ iae);
						}
					}
				}
	...
	/**
	 * Return the java.lang.reflect.Field {@code serialPersistentFields} if
	 * class {@code cl} implements it. Return null otherwise.
	 * 
	 * @param cl
	 *            a java.lang.Class which to test
	 * @return {@code java.lang.reflect.Field} if the class has
	 *         serialPersistentFields {@code null} if the class does not have
	...
	/**
	 * Return true if the given class {@code cl} has the compiler-generated
	 * method {@code clinit}. Even though it is compiler-generated, it is used
	 * by the serialization code to compute SUID. This is unfortunate, since it
	 * may depend on compiler optimizations in some cases.
	 * 
	 * @param cl
	 *            a java.lang.Class which to test
	 * @return {@code true} if the class has <clinit> {@code false} if the class
	 *         does not have <clinit>
	 */
	private static native boolean hasClinit(Class<?> cl);

	/**
	 * Return true if instances of class {@code cl} are Externalizable, false
	 * otherwise.
	 * 
	 * @param cl
	 *            a java.lang.Class which to test
	 * @return {@code true} if instances of the class are Externalizable
	 *         {@code false} if instances of the class are not Externalizable
	 * 
	 * @see Object#hashCode
	 */
	 ...
	 *         {@code false} if the typecode represents an Object type
	 *         (including arrays)
	 * 
	 * @see Object#hashCode
	 */
	...
	/**
	 * Return true if instances of class {@code cl} are Serializable, false
	 * otherwise.
	 * 
	 * @param cl
	 *            a java.lang.Class which to test
	 * @return {@code true} if instances of the class are Serializable
	 *         {@code false} if instances of the class are not Serializable
	 * 
	 * @see Object#hashCode
	 */
	...
	/**
	 * Returns the descriptor for a serializable class. Returns null if the
	 * class doesn't implement {@code Serializable} or {@code Externalizable}.
	 * 
	 * @param cl
	...
	/**
	 * Returns the descriptor for any class, whether or not the class implements
	 ...
	 * {@code cl}. Returns an ObjectStreamClass even if instances of the class
	...
	static ObjectStreamClass lookupStreamClass(Class<?> cl) {
		...
		WeakHashMap<Class<?>, ObjectStreamClass> tlc = OSCThreadLocalCache.oscWeakHashMap
				.get();
