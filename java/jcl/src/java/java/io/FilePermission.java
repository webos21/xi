 ...
 * and directories contained in that directory. If the pathname ends in
 * {@code /-}, it includes all the files and directories in that directory
 * <i>recursively</i>. The following pathnames have a special meaning:
 * <ul>
 * <li>
 * "*": all files in the current directory;</li>
 * <li>
 * "-": recursively all files and directories in the current directory;</li>
 * <li>
 * "&lt;&lt;ALL FILES&gt;&gt;": any file and directory in the file system.</li>
 * </ul>
 */
public final class FilePermission extends Permission implements Serializable {
	...
	private void init(final String path, String pathActions) {
		if (pathActions == null || pathActions.isEmpty()) {
			throw new IllegalArgumentException(
					"pathActions == null || pathActions.isEmpty()");
		}
	 ...
	 * {@code FilePermission}, if {@code p}'s actions are a subset of this file
	 * permission's actions and if {@code p}'s path is implied by this file
	 * permission's path.
	 * 
	 * @param p
