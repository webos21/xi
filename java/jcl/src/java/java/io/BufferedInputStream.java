...
public class BufferedInputStream extends FilterInputStream {
	...
	/**
	 * Constructs a new {@code BufferedInputStream}, providing {@code in} with a
	 * buffer of 8192 bytes.
	 * 
	 * <p>
	 * <strong>Warning:</strong> passing a null source creates a closed
	...
	/**
	 * Constructs a new {@code BufferedInputStream}, providing {@code in} with
	...
	public synchronized void reset() throws IOException {
		// BEGIN android-changed
		/*
		 * These exceptions get thrown in some "normalish" circumstances, so it
		 * is preferable to avoid loading up the whole big set of messages just
		 * for these cases.
		 */
		if (buf == null) {
