...
public class CharArrayWriter extends Writer {
	...
	/**
	 * Closes this writer. The implementation in {@code CharArrayWriter} does
	 * nothing.
	 */
	@Override
	public void close() {
	...
	/**
	 * Flushes this writer. The implementation in {@code CharArrayWriter} does
	 * nothing.
	 */
	@Override
	public void flush() {
	...
	/**
	 * Writes the specified character {@code oneChar} to this writer. This
	 * implementation writes the two low order bytes of the integer
	 ...
	 *             if {@code offset < 0} or {@code len < 0}, or if
	 *             {@code offset + len} is bigger than the length of {@code str}
	 *             .
	 */
	@Override
	...
	/**
	 * Writes the contents of this {@code CharArrayWriter} to another
	 * {@code Writer}. The output is all the characters that have been written
	 * to the receiver since the last reset or since it was created.
	 * 
	 * @param out
	 ...
	 * 
	 * @param csq
	 *            the {@code CharSequence} appended to the
	 *            {@code CharArrayWriter}, may be {@code null}.
	 * @return this CharArrayWriter.
	 */
	@Override
	...
	/**
	 * Append a subsequence of a {@code CharSequence} to the
	 * {@code CharArrayWriter}. The first and last characters of the subsequence
	 * are specified by the parameters {@code start} and {@code end}. A call to
	 * {@code CharArrayWriter.append(csq)} works the same way as
	 * {@code CharArrayWriter.write(csq.subSequence(start, end).toString)}. If
	 * {@code csq} is {@code null}, then it will be substituted with the string
	 * {@code "null"}.
	 * 
	 * @param csq
	 *            the {@code CharSequence} appended to the
	 ...
	 *            {@code CharSequence} appended to the {@code CharArrayWriter}.
	 * @return this CharArrayWriter.
	 * @throws IndexOutOfBoundsException
