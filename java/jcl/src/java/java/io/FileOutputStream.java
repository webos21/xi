...
public class FileOutputStream extends OutputStream implements Closeable {
	...
	/**
	 * Constructs a new FileOutputStream on the File {@code file}. The parameter
	...
	/**
	 * Constructs a new FileOutputStream on the file named {@code filename}. The
	 * parameter {@code append} determines whether or not the file is opened and
	 * appended to or just opened and overwritten. The {@code filename} may be
	 * absolute or relative to the system property {@code "user.dir"}.
	 * 
	 * @param filename
	 *            the name of the file to which this stream writes.
	 * @param append
