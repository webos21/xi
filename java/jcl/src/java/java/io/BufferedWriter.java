...
public class BufferedWriter extends Writer {
	...
	/**
	 * Constructs a new {@code BufferedWriter}, providing {@code out} with a
	 * buffer of 8192 bytes.
	 * 
	 * @param out
	 *            the {@code Writer} the buffer writes to.
	 */
	...
	/**
	 * Constructs a new {@code BufferedWriter}, providing {@code out} with
	 * {@code size} bytes of buffer.
	 * 
	 * @param out
	 *            the {@code OutputStream} the buffer writes to.
	 * @param size
	...
	/**
	 * Writes the character {@code oneChar} to this writer. If the buffer gets
	 * full by writing this character, this writer is flushed. Only the lower
	 * two bytes of the integer {@code oneChar} are written.
	 * 
	 * @param oneChar
