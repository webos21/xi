...
public interface DataOutput {
	...
	/**
	 * Writes the specified 16-bit short. Only the lower two bytes of
	 * {@code val} are written with the higher one written first.
	 * 
	 * @param val
	 *            the short to write.
	 * @throws IOException
	 ...
	 * 
	 * @param str
	 *            the string to write encoded in {@link DataInput modified
	 *            UTF-8}.
	 * @throws IOException
	 *             if an I/O error occurs while writing.
