...
class EmulatedFieldsForDumping extends ObjectOutputStream.PutField {
	...
	/**
	 * Find and set the double value of a given field named <code>name</code> in
	 * the receiver.
	 * 
	 * @param name
	 *            A String, the name of the field to set
	...
	/**
	 * Find and set the float value of a given field named <code>name</code> in
	 * the receiver.
	 * 
	 * @param name
	 *            A String, the name of the field to set
	...
	/**
	 * Find and set the Object value of a given field named <code>name</code> in
	 * the receiver.
	 * 
	 * @param name
	 *            A String, the name of the field to set
	...
	/**
	 * Find and set the short value of a given field named <code>name</code> in
	 * the receiver.
	 * 
	 * @param name
	 *            A String, the name of the field to set
