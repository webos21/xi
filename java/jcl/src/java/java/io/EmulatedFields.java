...
class EmulatedFields {
	...
	/**
	 * Finds and returns an ObjectSlot that corresponds to a field named
	 * {@code fieldName} and type {@code fieldType}. If the field type
	 * {@code fieldType} corresponds to a primitive type, the field type has to
	 * match exactly or {@code null} is returned. If the field type
	 * {@code fieldType} corresponds to an object type, the field type has to be
	 * compatible in terms of assignment, or null is returned. If
	 * {@code fieldType} is {@code null}, no such compatibility checking is
	 * performed and the slot is returned.
	 * 
	 * @param fieldName
	...
	/**
	 * Finds and returns the byte value of a given field named {@code name} in
	...
	/**
	 * Finds and returns the char value of a given field named {@code name} in
	 * the receiver. If the field has not been assigned any value yet, the
	 * default value {@code defaultValue} is returned instead.
	 * 
	 * @param name
	...
	/**
	 * Finds and returns the double value of a given field named {@code name} in
	 * the receiver. If the field has not been assigned any value yet, the
	 * default value {@code defaultValue} is returned instead.
	 * 
	 * @param name
	...
	/**
	 * Finds and returns the int value of a given field named {@code name} in
	 * the receiver. If the field has not been assigned any value yet, the
	 * default value {@code defaultValue} is returned instead.
	 * 
	 * @param name
	...
	/**
	 * Finds and returns the long value of a given field named {@code name} in
	 * the receiver. If the field has not been assigned any value yet, the
	 * default value {@code defaultValue} is returned instead.
	 * 
	 * @param name
	...
	/**
	 * Finds and returns the boolean value of a given field named {@code name}
