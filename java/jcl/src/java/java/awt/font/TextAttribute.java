...
/**
 * The TextAttribute class defines attribute keys and attribute values for text
 * rendering. Each TextAttributes should have the following information:
 * <ul>
 * <li>key name;</li>
 * <li>valid values;</li>
...
public final class TextAttribute extends Attribute {
	...
	/**
	 * The Constant JUSTIFICATION_NONE indicates that line is not allowed for
	 * justification.
	 */
	...
	/**
	 * The Constant SWAP_COLORS_ON indicates a swap of foreground and
	 * background.
	 */
	...
	/**
	 * The Constant UNDERLINE_ON indicates a standard underline at the roman
	 * baseline for roman text.
	 */
	public static final Integer UNDERLINE_ON = 0;

	/**
	 * The Constant UNDERLINE_LOW_ONE_PIXEL indicates a single pixel solid low
	 * underline.
	 */
	public static final Integer UNDERLINE_LOW_ONE_PIXEL = 1;

	/**
	 * The Constant UNDERLINE_LOW_TWO_PIXEL indicates a double pixel solid low
	 * underline.
	 */
	public static final Integer UNDERLINE_LOW_TWO_PIXEL = 2;

	/**
	 * The Constant UNDERLINE_LOW_DOTTED indicates a single pixel dotted low
	 * underline.
	 */
	public static final Integer UNDERLINE_LOW_DOTTED = 3;

	/**
	 * The Constant UNDERLINE_LOW_GRAY indicates double pixel gray low
	 * underline.
	 */
	public static final Integer UNDERLINE_LOW_GRAY = 4;

	/**
	 * The Constant UNDERLINE_LOW_DASHED indicates single pixel dashed low
	 * underline.
	 */
	...
	/**
	 * The Constant WEIGHT_DEMILIGHT indicates an intermediate weight between
	 * LIGHT and STANDARD.
	 */
	...
	/**
	 * The Constant WEIGHT_MEDIUM indicates average weight between the REGULAR
	 * and BOLD.
	 */
	...
	/**
	 * The Constant WIDTH_CONDENSED indicates the most condensed predefined
	 * width.
	 */
