 ...
 * strings, where all accesses are synchronized. This class has mostly been
 * replaced by {@link StringBuilder} because this synchronization is rarely
 * useful. This class is mainly used to interact with legacy APIs that expose
 * it.
 * 
 * <p>
