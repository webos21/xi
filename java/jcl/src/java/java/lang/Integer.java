...
public final class Integer extends Number implements Comparable<Integer> {
	 ...
	 * online, Figure 5-18 (http://www.hackersdelight.org/revisions.pdf) The
	 * entries whose value is -1 are never referenced.
	 */
	private static final byte[] NTZ_TABLE = { 32, 0, 1, 12, 2, 6, -1, 13, 3,
			-1, 7, -1, -1, -1, -1, 14, 10, 4, -1, -1, 8, -1, -1, 25, -1, -1,
			-1, -1, -1, 21, 27, 15, 31, 11, 5, -1, -1, -1, -1, -1, 9, -1, -1,
			24, -1, -1, 20, 26, 30, -1, -1, -1, -1, 23, -1, 19, 29, -1, 22, 18,
			28, 17, 16, -1 };
	...
	public static final Class<Integer> TYPE = (Class<Integer>) int[].class
			.getComponentType();
	...
	/**
	 * Converts the specified signed integer into a string representation based
	 * on the specified radix. The returned string is a concatenation of a minus
	 ...
	 * and returns the bit mask value for that bit. This is also referred to as
	 * the Least Significant 1 Bit. Returns zero if the specified integer is
	 * zero.
	 * 
	 * @param i
	 *            the integer to examine.
	...
	public static int numberOfTrailingZeros(int i) {
		...
		// BEGIN android-changed - Harmony version should be one-liner in
		// comment below
		i &= -i;
		i = (i << 4) + i; // x *= 17
		i = (i << 6) + i; // x *= 65
