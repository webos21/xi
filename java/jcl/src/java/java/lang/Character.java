 ...
 * 
 * <p>
 * Character data is kept up to date as Unicode evolves. See the <a
 * href="../util/Locale.html#locale_data">Locale data</a> section of the
 * {@code Locale} documentation for details of the Unicode versions implemented
 * by current and historical Android releases.
 * 
 * <p>
 * The Unicode specification, character tables, and other information are
 * available at <a href="http://www.unicode.org/">http://www.unicode.org/</a>.
 * 
 * <p>
 ...
 * 
 * <a name="unicode_categories">
 * <h3>Unicode categories</h3></a>
 * <p>
 * Here's a list of the Unicode character categories and the corresponding Java
 * constant, grouped semantically to provide a convenient overview. This table
 * is also useful in conjunction with {@code \p} and {@code \P} in
 * {@link java.util.regex.Pattern regular expressions}. <span class="datatable">
 * <style type="text/css"> .datatable td { padding-right: 20px; } </style>
 * <p>
 * <table>
 * <tr>
 * <td>Cn</td>
 * <td>Unassigned</td>
 * <td>{@link #UNASSIGNED}</td>
 * </tr>
 * <tr>
 * <td>Cc</td>
 * <td>Control</td>
 ...
 * <td>Cf</td>
 * <td>Private use</td>
 * <td>{@link #PRIVATE_USE}</td>
 * </tr>
 * <tr>
 * <td>Cf</td>
 * <td>Surrogate</td>
 * <td>{@link #SURROGATE}</td>
 * </tr>
 * <tr>
 * <td><br>
 * </td>
 ...
 * <td>{@link #UPPERCASE_LETTER}</td>
 * </tr>
 * <tr>
 * <td>Ll</td>
 * <td>Lowercase letter</td>
 * <td>{@link #LOWERCASE_LETTER}</td>
 * </tr>
 * <tr>
 * <td>Lt</td>
 * <td>Titlecase letter</td>
 * <td>{@link #TITLECASE_LETTER}</td>
 * </tr>
 * <tr>
 * <td>Lm</td>
 * <td>Modifier letter</td>
 * <td>{@link #MODIFIER_LETTER}</td>
 * </tr>
 * <tr>
 * <td>Lo</td>
 * <td>Other letter</td>
 * <td>{@link #OTHER_LETTER}</td>
 * </tr>
 * <tr>
 * <td><br>
 * </td>
 ...
 * <td>{@link #NON_SPACING_MARK}</td>
 * </tr>
 * <tr>
 * <td>Me</td>
 * <td>Enclosing mark</td>
 * <td>{@link #ENCLOSING_MARK}</td>
 * </tr>
 * <tr>
 * <td>Mc</td>
 * <td>Combining spacing mark</td>
 * <td>{@link #COMBINING_SPACING_MARK}</td>
 * </tr>
 * <tr>
 * <td><br>
 * </td>
 ...
 * <td>{@link #DECIMAL_DIGIT_NUMBER}</td>
 * </tr>
 * <tr>
 * <td>Nl</td>
 * <td>Letter number</td>
 * <td>{@link #LETTER_NUMBER}</td>
 * </tr>
 * <tr>
 * <td>No</td>
 * <td>Other number</td>
 * <td>{@link #OTHER_NUMBER}</td>
 * </tr>
 * <tr>
 * <td><br>
 * </td>
 ...
 * <td>{@link #DASH_PUNCTUATION}</td>
 * </tr>
 * <tr>
 * <td>Ps</td>
 * <td>Start punctuation</td>
 * <td>{@link #START_PUNCTUATION}</td>
 * </tr>
 * <tr>
 * <td>Pe</td>
 * <td>End punctuation</td>
 * <td>{@link #END_PUNCTUATION}</td>
 * </tr>
 * <tr>
 * <td>Pc</td>
 * <td>Connector punctuation</td>
 * <td>{@link #CONNECTOR_PUNCTUATION}</td>
 * </tr>
 * <tr>
 * <td>Pi</td>
 * <td>Initial quote punctuation</td>
 * <td>{@link #INITIAL_QUOTE_PUNCTUATION}</td>
 * </tr>
 * <tr>
 * <td>Pf</td>
 * <td>Final quote punctuation</td>
 * <td>{@link #FINAL_QUOTE_PUNCTUATION}</td>
 * </tr>
 * <tr>
 * <td>Po</td>
 * <td>Other punctuation</td>
 * <td>{@link #OTHER_PUNCTUATION}</td>
 * </tr>
 * <tr>
 * <td><br>
 * </td>
 ...
 * <td>Sm</td>
 * <td>Math symbol</td>
 * <td>{@link #MATH_SYMBOL}</td>
 * </tr>
 * <tr>
 * <td>Sc</td>
 * <td>Currency symbol</td>
 * <td>{@link #CURRENCY_SYMBOL}</td>
 * </tr>
 * <tr>
 * <td>Sk</td>
 * <td>Modifier symbol</td>
 * <td>{@link #MODIFIER_SYMBOL}</td>
 * </tr>
 * <tr>
 * <td>So</td>
 * <td>Other symbol</td>
 * <td>{@link #OTHER_SYMBOL}</td>
 * </tr>
 * <tr>
 * <td><br>
 * </td>
 ...
 * <td>{@link #SPACE_SEPARATOR}</td>
 * </tr>
 * <tr>
 * <td>Zl</td>
 * <td>Line separator</td>
 * <td>{@link #LINE_SEPARATOR}</td>
 * </tr>
 * <tr>
 * <td>Zp</td>
 * <td>Paragraph separator</td>
 * <td>{@link #PARAGRAPH_SEPARATOR}</td>
 * </tr>
 * </table>
 * </span>
 * 
...
public final class Character implements Serializable, Comparable<Character> {
	...
	public static final Class<Character> TYPE = (Class<Character>) char[].class
			.getComponentType();
	...
	public static final class UnicodeBlock extends Subset {
		 ...
		 */
		private static UnicodeBlock[] BLOCKS = new UnicodeBlock[] { null,
				...
				UnicodeBlock.COMBINING_DIACRITICAL_MARKS, UnicodeBlock.GREEK,
				UnicodeBlock.CYRILLIC, UnicodeBlock.ARMENIAN,
				UnicodeBlock.HEBREW, UnicodeBlock.ARABIC, UnicodeBlock.SYRIAC,
				UnicodeBlock.THAANA, UnicodeBlock.DEVANAGARI,
				UnicodeBlock.BENGALI, UnicodeBlock.GURMUKHI,
				UnicodeBlock.GUJARATI, UnicodeBlock.ORIYA, UnicodeBlock.TAMIL,
				UnicodeBlock.TELUGU, UnicodeBlock.KANNADA,
				UnicodeBlock.MALAYALAM, UnicodeBlock.SINHALA,
				UnicodeBlock.THAI, UnicodeBlock.LAO, UnicodeBlock.TIBETAN,
				UnicodeBlock.MYANMAR, UnicodeBlock.GEORGIAN,
				UnicodeBlock.HANGUL_JAMO, UnicodeBlock.ETHIOPIC,
				UnicodeBlock.CHEROKEE,
				UnicodeBlock.UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS,
				UnicodeBlock.OGHAM, UnicodeBlock.RUNIC, UnicodeBlock.KHMER,
				UnicodeBlock.MONGOLIAN, UnicodeBlock.LATIN_EXTENDED_ADDITIONAL,
				UnicodeBlock.GREEK_EXTENDED, UnicodeBlock.GENERAL_PUNCTUATION,
				UnicodeBlock.SUPERSCRIPTS_AND_SUBSCRIPTS,
				UnicodeBlock.CURRENCY_SYMBOLS,
				UnicodeBlock.COMBINING_MARKS_FOR_SYMBOLS,
				UnicodeBlock.LETTERLIKE_SYMBOLS, UnicodeBlock.NUMBER_FORMS,
				UnicodeBlock.ARROWS, UnicodeBlock.MATHEMATICAL_OPERATORS,
				UnicodeBlock.MISCELLANEOUS_TECHNICAL,
				UnicodeBlock.CONTROL_PICTURES,
				UnicodeBlock.OPTICAL_CHARACTER_RECOGNITION,
				UnicodeBlock.ENCLOSED_ALPHANUMERICS, UnicodeBlock.BOX_DRAWING,
				UnicodeBlock.BLOCK_ELEMENTS, UnicodeBlock.GEOMETRIC_SHAPES,
				...
				UnicodeBlock.BOPOMOFO, UnicodeBlock.HANGUL_COMPATIBILITY_JAMO,
				UnicodeBlock.KANBUN, UnicodeBlock.BOPOMOFO_EXTENDED,
				UnicodeBlock.ENCLOSED_CJK_LETTERS_AND_MONTHS,
				UnicodeBlock.CJK_COMPATIBILITY,
				UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A,
				UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS, UnicodeBlock.YI_SYLLABLES,
				UnicodeBlock.YI_RADICALS, UnicodeBlock.HANGUL_SYLLABLES,
				UnicodeBlock.HIGH_SURROGATES,
				UnicodeBlock.HIGH_PRIVATE_USE_SURROGATES,
				UnicodeBlock.LOW_SURROGATES, UnicodeBlock.PRIVATE_USE_AREA,
				...
				UnicodeBlock.OLD_ITALIC, UnicodeBlock.GOTHIC,
				UnicodeBlock.DESERET, UnicodeBlock.BYZANTINE_MUSICAL_SYMBOLS,
				UnicodeBlock.MUSICAL_SYMBOLS,
				UnicodeBlock.MATHEMATICAL_ALPHANUMERIC_SYMBOLS,
				UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B,
				UnicodeBlock.CJK_COMPATIBILITY_IDEOGRAPHS_SUPPLEMENT,
				UnicodeBlock.TAGS, UnicodeBlock.CYRILLIC_SUPPLEMENTARY,
				UnicodeBlock.TAGALOG, UnicodeBlock.HANUNOO, UnicodeBlock.BUHID,
				...
				UnicodeBlock.LIMBU, UnicodeBlock.TAI_LE,
				UnicodeBlock.KHMER_SYMBOLS, UnicodeBlock.PHONETIC_EXTENSIONS,
				UnicodeBlock.MISCELLANEOUS_SYMBOLS_AND_ARROWS,
				UnicodeBlock.YIJING_HEXAGRAM_SYMBOLS,
				UnicodeBlock.LINEAR_B_SYLLABARY,
				UnicodeBlock.LINEAR_B_IDEOGRAMS, UnicodeBlock.AEGEAN_NUMBERS,
				UnicodeBlock.UGARITIC, UnicodeBlock.SHAVIAN,
				UnicodeBlock.OSMANYA, UnicodeBlock.CYPRIOT_SYLLABARY,
	...
	/**
	 * Returns the code point that precedes {@code index} in the specified array
	...
	public static int getType(int codePoint) {
		...
		// The type values returned by ICU are not RI-compatible. The RI skips
		// the value 17.
	...
	public static boolean isJavaIdentifierStart(int codePoint) {
		...
		// Optimized case for ASCII
		if (codePoint < 64) {
			return (codePoint == '$'); // There's only one character in this
										// range.
		} else if (codePoint < 128) {
	...
	public static boolean isSpaceChar(int codePoint) {
		...
		if (codePoint <= 0xffff) {
			return codePoint <= 0x200b || codePoint == 0x2028
	...
	public static boolean isWhitespace(int codePoint) {
		...
		if (codePoint <= 0xffff) {
			return codePoint <= 0x200b || codePoint == 0x2028
					|| codePoint == 0x2029 || codePoint == 0x3000;
		}
