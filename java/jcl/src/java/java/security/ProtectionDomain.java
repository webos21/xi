...
public class ProtectionDomain {
	 ...
	 * <p>
	 * The policy will not be consulted by access checks against this
	 ...
	 * 
	 * @param cs
	 *            the code source associated with this domain, maybe
	 *            {@code null}.
	 * @param permissions
	 ...
	 * consulted. If {@code permissions} is not {@code null}, the
	 * {@code permissions} collection is made immutable by calling
	 ...
	 *            {@code null}.
	 * @param permissions
	 *            the permissions associated with this domain, maybe
	 *            {@code null}.
	 * @param cl
	 *            the class loader associated with this domain, maybe
	 *            {@code null}.
	 * @param principals
	...
	/**
	 * Returns the {@code ClassLoader} associated with this
	 * {@code ProtectionDomain}.
	 * 
	 * @return the {@code ClassLoader} associated with this
	 *         {@code ProtectionDomain}, maybe {@code null}.
	 */
	 ...
	 * {@code ProtectionDomain}.
	 * 
	 * @return the static permissions that are granted to this
	 *         {@code ProtectionDomain}, maybe {@code null}.
	 */
	...
	public String toString() {
		...
		buf.append("CodeSource=")
				.append(codeSource == null ? "<null>" : codeSource.toString())
				.append("\n");
		buf.append("ClassLoader=")
				.append(classLoader == null ? "<null>" : classLoader.toString())
				.append("\n");
		if (principals == null || principals.length == 0) {
			...
			for (int i = 0; i < principals.length; i++) {
				buf.append("\t")
						.append(principals[i] == null ? "<null>"
								: principals[i].toString()).append("\n");
			}
			buf.append(">");
		}
		...
		if (permissions == null) {
			...
			buf.append("\t\tstatic: ").append(permissions.toString())
					.append("\n");
		}
