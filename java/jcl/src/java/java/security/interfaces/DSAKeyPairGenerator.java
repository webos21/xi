...
public interface DSAKeyPairGenerator {
	...
	/**
	 * Initializes this generator with the prime ({@code p}), subprime ({@code q}
	 * ), and base ({@code g}) values from the specified parameters.
	 * 
	 * @param params
	 ...
	 * ) values or whether it will use the pre-calculated values for the
	 * specified modulus length. Default parameters are available for modulus
	 ...
	 *             no pre-calculated values and {@code genParams} is
	 *             {@code false}.
	 */
