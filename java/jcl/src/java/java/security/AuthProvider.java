...
/**
 * {@code AuthProvider} is an abstract superclass for Java Security
 * {@code Provider} which provide login and logout.
 */
public abstract class AuthProvider extends Provider {
	...
	/**
	 * Performs a login into this {@code AuthProvider}. The specified
	 * {@code CallbackHandler} is used to obtain information from the caller.
	 * <p>
	 ...
	 * <p>
	 * If no handler is set, this {@code AuthProvider} uses the
	 * {@code CallbackHandler} specified by the
