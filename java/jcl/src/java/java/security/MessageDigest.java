 ...
 * <h4>Sample Code</h4>
 * <p>
 * The basic pattern to digest an {@link java.io.InputStream} looks like this:
 * 
 * <pre>
 ...
 * 
 * <p>
 * That is, after creating or resetting a {@code MessageDigest} you should call
 * {@link #update(byte[],int,int)} for each block of input data, and then call
 * {@link #digest} to get the final digest. Note that calling {@code digest}
 * resets the {@code MessageDigest}. Advanced users who want partial digests
 * should clone their {@code MessageDigest} before calling {@code digest}.
 * 
 * <p>
...
public abstract class MessageDigest extends MessageDigestSpi {
	...
	/**
	 * Constructs a new instance of {@code MessageDigest} with the name of the
	 * algorithm to use.
	 * 
	 * @param algorithm
