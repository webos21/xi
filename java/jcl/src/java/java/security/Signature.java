...
public abstract class Signature extends SignatureSpi {
	...
	/**
	 * Constructs a new instance of {@code Signature} with the name of the
	 * algorithm to use.
	 * 
	 * @param algorithm
	...
	/**
	 * Indicates whether the given {@code signature} starting at index
	 * {@code offset} with {@code length} bytes can be verified using the public
	 ...
	 * {@code byte[]}, starting form the specified index for the specified
	 * length.
	 * 
	 * @param data
	 *            the byte array to update with.
	 ...
	 * @return the value of the parameter with the specified name, maybe
	 *         {@code null}.
	 * @throws InvalidParameterException
	 *             if {@code param} is not a valid parameter for this
	 *             {@code Signature} or an other error occures.
