...
public class ECFieldF2m implements ECField {
	...
	/**
	 * Creates a new {@code ECFieldF2m} with {@code 2^m} elements with a
	 * polynomial basis and the reduction polynomial based on {@code rp}.
	 * <p>
	...
	/**
	 * Creates a new {@code ECFieldF2m} with {@code 2^m} elements with a
	 * polynomial basis and the reduction polynomial based on {@code ks}.
	 * <p>
	 * The reduction polynomial must be either <i>trinomial</i> or
	 * <i>pentanomial</i>.
	 * 
	 ...
	 *            the exponent {@code m} for the number of elements.
	 * @param ks
	 *            the base of the reduction polynomial with coefficients given
	 *            in descending order.
	 * @throws IllegalArgumentException
	 ...
	 * @return {@code true} if the specified object is equal to this finite
	 *         field, otherwise {@code false}.
	 */
