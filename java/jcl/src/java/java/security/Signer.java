...
public abstract class Signer extends Identity {
	...
	/**
	 * Returns the private key of this {@code Signer}. If a
	 * {@code SecurityManager} is installed, code calling this method needs the
	 * {@code SecurityPermission} {@code "getSignerPrivateKey"} to be granted,
	...
	/**
	 * Associates the specified key pair with this {@code Signer}. If a
	 * {@code SecurityManager} is installed, code calling this method needs the
	 * {@code SecurityPermission} {@code getSignerPrivateKey} to be granted,
	 * otherwise a {@code SecurityException} will be thrown.
	 * 
