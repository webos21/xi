...
public final class CodeSigner implements Serializable {
	 ...
	 * @param timestamp
	 *            the time stamp associated with this code signer, maybe
	 *            {@code null}.
	 ...
	 *         {@code CodeSigner}, otherwise {@code false}.
	 */
	@Override
	...
	public String toString() {
		...
		// The javadoc says nothing, and the others implementations behavior
		// seems as
		// dumping only the first certificate. Well, let's do the same.
		buf.append("CodeSigner [").append(
