...
/**
 * {@code DomainCombiner} is used to update and optimize
 * {@code ProtectionDomain}s from an {@code AccessControlContext}.
 * 
...
public interface DomainCombiner {
	 ...
	 *            ).
	 * @param assigned
	 *            the protection domains of the parent thread, maybe
	 *            {@code null}.
