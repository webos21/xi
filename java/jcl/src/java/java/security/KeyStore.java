 ...
 * {@code 'keystore.type'} property in the file named
 * {@code JAVA_HOME/lib/security/java.security}.
 * 
 * @see Certificate
 * @see PrivateKey
 */
public class KeyStore {
	 ...
	 *             if an error occurred during the creation of the new
	 *             {@code KeyStore}.
	...
	public static KeyStore getInstance(String type) throws KeyStoreException {
		...
		synchronized (engine) {
			try {
				...
				return new KeyStore((KeyStoreSpi) engine.spi, engine.provider,
						type);
	 ...
	 * @throws NullPointerException
	 *             if {@code type == null} (instead of NoSuchAlgorithmException)
	 *             as in 1.4 release
	 * @see #getDefaultType
	 */
	...
	/**
	 * Stores this {@code KeyStore} using the specified
	...
	/**
	 * Loads this {@code KeyStore} using the specified
	 * {@code LoadStoreParameter}.
	 * 
	 * @param param
	 ...
	 *             if this {@code KeyStore} is not initialized.
	 * @throws NullPointerException
	 *             if {@code alias} is {@code null} or {@code entry} is
	 *             {@code null}.
	 */
	...
	public abstract static class Builder {
		...
		/**
		 * Returns the {@code ProtectionParameter} to be used when a
		 * {@code Entry} with the specified alias is requested. Before this
		 * method is invoked, {@link #getKeyStore()} must be called.
		 * 
		 * @param alias
		 *            the alias for the entry.
		 * @return the {@code ProtectionParameter} to be used when a
		 *         {@code Entry} with the specified alias is requested.
		 * @throws KeyStoreException
		 ...
		 *         {@code KeyStore} and the specified
		 *         {@code ProtectionParameter}.
		 * @throws NullPointerException
		...
		public static Builder newInstance(KeyStore keyStore,
			...
			if (!keyStore.isInit) {
				throw new IllegalArgumentException(
						"KeyStore was not initialized");
			}
			return new BuilderImpl(keyStore, protectionParameter, null, null,
					null, null);
		}
		 ...
		 *            maybe {@code null}.
		 * @param file
		 *            the {@code File} that contains the data for the
		 *            {@code KeyStore}.
		 * @param protectionParameter
		 ...
		 *             {@code PasswordProtection} or
		 *             {@code CallbackHandlerProtection}, {@code file} is not a
		...
		public static Builder newInstance(String type, Provider provider,
			...
			// create new instance
			return new BuilderImpl(null, protectionParameter, file, type,
					provider, AccessController.getContext());
		}
		 ...
		 *         based on the provided arguments.
		 * @throws NullPointerException
		 *             if {@code type} or {@code protectionParameter} is
		 *             {@code null}.
		 * @throws IllegalArgumentException
		 *             {@code protectionParameter} not an instance of either
		 *             {@code PasswordProtection} or
		...
		public static Builder newInstance(String type, Provider provider,
			...
			return new BuilderImpl(null, protectionParameter, null, type,
					provider, AccessController.getContext());
		}
	...
	public static class PasswordProtection implements ProtectionParameter,
		 ...
		 * password. A copy of the password is stored in the new
		 * {@code PasswordProtection} object.
		 * 
		 * @param password
	...
	/**
	 * {@code PrivateKeyEntry} represents a {@code KeyStore} entry that holds a
	 * private key.
	 */
	public static final class PrivateKeyEntry implements Entry {
		...
		public PrivateKeyEntry(PrivateKey privateKey, Certificate[] chain) {
			...
			if (!(chain[0].getPublicKey().getAlgorithm()).equals(privateKey
					.getAlgorithm())) {
				throw new IllegalArgumentException(
						"Algorithm of private key does not match "
	...
	/**
	 * {@code SecretKeyEntry} represents a {@code KeyStore} entry that holds a
	 * secret key.
	 */
	...
	public static final class TrustedCertificateEntry implements Entry {
		 ...
		 * 
		 * @return a printable representation for this
