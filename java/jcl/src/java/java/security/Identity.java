...
public abstract class Identity implements Principal, Serializable {
		...
		if (publicKey != null) {
			if (!checkKeysEqual(publicKey, certPK)) {
				throw new KeyManagementException(
						"Cert's public key does not match Identity's public key");
			}
		} else {
			publicKey = certPK;
		}
	 ...
	 * modifications of the returned array has no impact on this
	 * {@code Identity}.
	 * 
	 ...
	 * @return {@code true} if the {@code Identity} objects are equal,
	 *         {@code false} otherwise.
	 */
	 ...
	 * @throws KeyManagementException
	 *             if another {@code Identity} in the same scope as this
	 *             {@code Identity} already has the same {@code PublicKey}.
	 * @throws SecurityException
	 *             if a {@code SecurityManager} is installed and the caller does
	 *             not have permission to invoke this method.
	 */
	 ...
	 * 
	 * @param obj
	 *            object to be compared for equality with this {@code Identity}.
	 * @return {@code true} if the specified object is equal to this
	 *         {@code Identity}, otherwise {@code false}.
	 */
	@Override
