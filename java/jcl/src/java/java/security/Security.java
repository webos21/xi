...
public final class Security {
		...
		AccessController
				.doPrivileged(new java.security.PrivilegedAction<Void>() {
					public Void run() {
						...
						// BEGIN android-added
						/*
						 * Android only uses a local "security.properties"
						 * resource for configuration. TODO: Reevaluate this
						 * decision.
						 */
						try {
							...
							System.out
									.println("[Security] Can't load security.properties");
						...
						// if (Util.equalsIgnoreCase("true",
						// secprops.getProperty("security.allowCustomPropertiesFile",
						// "true"))) {
						// String securityFile =
						...
						// }
						// try {
						// securityFile = PolicyUtils.expand(securityFile,
	...
	/**
	 * Returns the {@code Provider} with the specified name. Returns
	 * {@code null} if name is {@code null} or no provider with the specified
	 * name is installed.
	 * 
	 * @param name
	 ...
	 *         {@code filter}. A {@code null} value signifies that none of the
	 ...
	 * specified {@code key}) to be granted, otherwise a
	 ...
	 * cryptographic service. {@code "Signature"}, {@code "Cipher"} and
	 * {@code "KeyStore"} are examples for such kind of services.
	 * 
	 * @param serviceName
	 *            the case-insensitive name of the service.
	 * @return a {@code Set} of all registered algorithms for the specified
	 *         cryptographic service, or an empty {@code Set} if
	 *         {@code serviceName} is {@code null} or if no registered provider
