...
public abstract class KeyStoreSpi {
	...
	/**
	 * Stores this {@code KeyStoreSpi} using the specified
	...
	/**
	 * Loads this {@code KeyStoreSpi} using the specified
	 * {@code LoadStoreParameter}.
	 * 
	 * @param param
	...
	public void engineLoad(KeyStore.LoadStoreParameter param)
		...
		throw new UnsupportedOperationException(
				"protectionParameter is neither PasswordProtection "
		...
		if (protParam != null) {
			if (protParam instanceof KeyStore.PasswordProtection) {
				...
				throw new UnrecoverableEntryException(
						"ProtectionParameter object is not "
	...
	public void engineSetEntry(String alias, KeyStore.Entry entry,
		...
		if (protParam instanceof KeyStore.PasswordProtection) {
			...
			if (protParam instanceof KeyStore.CallbackHandlerProtection) {
				...
				throw new KeyStoreException(
						"protParam should be PasswordProtection or "
		...
		if (entry instanceof KeyStore.PrivateKeyEntry) {
			...
			engineSetKeyEntry(alias, prE.getPrivateKey(), passW,
					prE.getCertificateChain());
			return;
		}
