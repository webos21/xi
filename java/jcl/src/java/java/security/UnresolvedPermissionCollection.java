...
/**
 * {@code UnresolvedPermissionCollection} represents a specific
 * {@code PermissionCollection} for storing {@link UnresolvedPermission}
 * instances. Contained elements are grouped by their target type.
 */
final class UnresolvedPermissionCollection extends PermissionCollection {
	...
	private static final ObjectStreamField[] serialPersistentFields = { new ObjectStreamField(
			"permissions", Hashtable.class), };

	// elements of the collection.
	private transient Map klasses = new HashMap();

	/**
	 * Adds an unresolved permission to this
	 * {@code UnresolvedPermissionCollection}.
	 * 
	 * @param permission
	 ...
	 *             if {@code permission} is {@code null} or not an
	...
	/**
	 * Returns true if this collection contains unresolved permissions with the
	 * same classname as argument permission.
	 */
