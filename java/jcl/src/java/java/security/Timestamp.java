...
public final class Timestamp implements Serializable {
	 ...
	 *             if {@code timestamp} is {@code null} or if
	 *             {@code signerCertPath} is {@code null}.
	 */
	 ...
	 * 
	 * @param obj
	 *            object to be compared for equality with this {@code Timestamp}
	 *            .
	 * @return {@code true} if the specified object is equal to this
	 *         {@code Timestamp}, otherwise {@code false}.
	 * @see #hashCode
	 */
	@Override
	 ...
	 * hash code for {@code Timestamp}s that are equal to each other as required
