...
public final class AccessControlContext {
	 ...
	 * 
	 * @param acc
	 *            the {@code AccessControlContext} related to the given
	 *            {@code DomainCombiner}
	 * @param combiner
	 *            the {@code DomainCombiner} related to the given
	...
	AccessControlContext(ProtectionDomain[] domains, AccessControlContext acc,
			DomainCombiner combiner) {
		this.context = combiner.combine(domains, acc.context);
		this.combiner = combiner;
	}
	 ...
	 * <il> <li>it must not be null <li>duplicates will be removed <li>null-s
	 * will be removed</li>
	 * 
	 * @param stack
	 *            - array of ProtectionDomains
	 * @param inherited
	 *            - inherited context, which may be null
	 */
	 ...
	 * <p>
	 * If privileged operations are on the call stack, only the
	 * {@code ProtectionDomain}s from the last privileged operation are taken
	 * into account.
	 * <p>
	 ...
	 * encapsulate the same {@code ProtectionDomain}s. The order of the
	 * {@code ProtectionDomain}s is ignored by this method.
	 * 
	 * @param obj
	 *            object to be compared for equality with this
	 *            {@code AccessControlContext}
	 * @return {@code true} if the specified object is equal to this
	 *         {@code AccessControlContext}, otherwise {@code false}
	 */
	@Override
