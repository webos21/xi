 ...
 * {@code CertPathValidator} class to be implemented by security providers.
 */
public abstract class CertPathValidatorSpi {
	...
	/**
	 * Validates the {@code CertPath} with the algorithm of this
	 * {@code CertPathValidator} using the specified algorithm parameters.
	 * 
	 * @param certPath
