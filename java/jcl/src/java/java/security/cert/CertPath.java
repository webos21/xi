...
public abstract class CertPath implements Serializable {
	 ...
	 * instance. It is the result of calling {@code toString} on all
	 * {@code Certificate}s in the {@code List}.
	 * 
	...
	public String toString() {
		...
		for (Iterator<? extends Certificate> i = getCertificates().iterator(); i
				.hasNext(); n++) {
	...
	/**
	 * Returns an immutable List of the {@code Certificate}s contained in the
	 * {@code CertPath}.
	 * 
