...
/**
 * The parameter specification for a PKIX {@code CertPathBuilder} algorithm used
 * to {@link CertPathBuilder#build(CertPathParameters) build} certificate chains
 * validated with the PKIX certification path validation.
 * <p>
