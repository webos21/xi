...
public class TrustAnchor {
	 ...
	 *            the ASN.1 DER encoded form of the name constraints or
	 *            {@code null} if none.
	...
	public TrustAnchor(X509Certificate trustedCert, byte[] nameConstraints) {
		...
		if (nameConstraints != null) {
			...
			System.arraycopy(nameConstraints, 0, this.nameConstraints, 0,
					this.nameConstraints.length);
	 ...
	 */
	public TrustAnchor(X500Principal caPrincipal, PublicKey caPublicKey,
			byte[] nameConstraints) {
		if (caPrincipal == null) {
	...
	public final byte[] getNameConstraints() {
		...
		System.arraycopy(nameConstraints, 0, ret, 0, nameConstraints.length);
		return ret;
	}
	 ...
	 *         trust anchor of this instance was not created with a
	 *         {@code X500Principal}.
	 */
