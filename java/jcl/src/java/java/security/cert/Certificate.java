...
public abstract class Certificate implements Serializable {
	...
	/**
	 * Compares the argument to the certificate, and returns {@code true} if
	 * they represent the <em>same</em> object using a class specific
	 * comparison. The implementation in Object returns {@code true} only if the
	 * argument is the exact same object as the callee (==).
	 * 
	 * @param other
	...
	protected static class CertificateRep implements Serializable {
		...
		/**
		 * Deserializes a {@code Certificate} from a serialized
		 * {@code CertificateRep} object.
		 * 
