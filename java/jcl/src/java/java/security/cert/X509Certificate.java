...
public abstract class X509Certificate extends Certificate implements
	 ...
	 * 
	 * @return the {@code issuer} as an implementation specific
	 *         {@code Principal}.
	 */
	 ...
	 * {@code ExtKeyUsageSyntax} field of the extended key usage extension.
	 * 
	 ...
	 * {@code BasicContraints} extension.
	 * 
	 * @return the path length of the certificate constraints if the extension
	 *         is present or {@code -1} if the extension is not present.
	 *         {@code Integer.MAX_VALUE} if there's not limit.
	 */
