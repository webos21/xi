...
public interface Principal {
	 ...
	 * 
	 * @param obj
	 *            object to be compared for equality with this {@code Principal}
	 *            .
	 * @return {@code true} if the specified object is equal to this
	 *         {@code Principal}, otherwise {@code false}.
	 */
	 ...
	 * hash code for {@code Principal}s that are equal to each other as required
