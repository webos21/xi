 ...
 * <p>
 * An {@code AclEntry} is a list of the {@link Permission}s that are granted
 * (<i>positive</i>) or denied (<i>negative</i>) to a {@link Principal}.
 */
public interface AclEntry extends Cloneable {
	 ...
	 * @return {@code true} on success, {@code false} if there is a principal
	 *         already set for this entry.
	 */
	 ...
	 * 
	 * @return {@code true} if this ACL entry is negative, {@code false} if it's
	 *         positive.
	 */
	boolean isNegative();
	 ...
	 * @return {@code true} if the specified permission is added, {@code false}
	 *         if the permission was already in this entry.
	 */
	 ...
	 * @return {@code true} if the permission is removed, {@code false} if the
	 *         permission was not in this entry.
	 */
	 ...
	 * @return {@code true} if the permission is in this entry, otherwise
	 *         {@code false}.
	 */
