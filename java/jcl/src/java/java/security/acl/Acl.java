 ...
 * owners are allowed to modify the {@code Acl}.
 * <p>
 ...
 * {@code Principal}, then that {@code Permission} is treated as neither granted
 * nor denied to that {@code Principal}.</li>
 ...
 * <li>If there is no {@code AclEntry} associated with a specific
 * {@code Principal}, then it is interpreted as an empty list of permissions.</li>
 * </ul>
 */
public interface Acl extends Owner {
	 ...
	 * positive</i> or <i>negative</i>) and principal, then the new entry is not
	 * added.
	 * 
	 * @param caller
	 *            the invoking {@code Principal}.
