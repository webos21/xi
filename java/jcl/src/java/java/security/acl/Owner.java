...
public interface Owner {
	 ...
	 * @param owner
	 *            the owner to added.
	 * @return {@code true} if the owner was added, {@code false} if it was
	 *         already an owner.
	 ...
	 * @return {@code true} if the owner was removed, {@code false} if it was
	 *         not an owner.
	 * @throws NotOwnerException
	 *             if the invoking principal is not an owner.
	 * @throws LastOwnerException
	 *             if the owner to be removed is the last owner and hence
	 *             removing it would make this object owner-less.
	 */
	 ...
	 * @return {@code true} if the specified principal is an owner, otherwise
	 *         {@code false}.
	 */
