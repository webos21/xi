...
public class TreeSet<E> extends AbstractSet<E> implements NavigableSet<E>,
	 ...
	 * {@code TreeSet} which contains elements greater or equal to the start
	 * element but less than the end element. The returned SortedSet is backed
	 * by this TreeSet so changes to one are reflected by the other.
	 * 
	 * @param start
	 *            the start element
	 * @param end
	...
	/**
	 * Returns a {@code SortedSet} of the specified portion of this
	 * {@code TreeSet} which contains elements less than the end element. The
	 * returned SortedSet is backed by this TreeSet so changes to one are
	 ...
	 * Returns a {@code SortedSet} of the specified portion of this
	 * {@code TreeSet} which contains elements greater or equal to the start
	 * element. The returned SortedSet is backed by this TreeSet so changes to
