...
/**
 * {@code Collection} is the root of the collection hierarchy. It defines
 * operations on data collections and the behavior that they will have in all
 * implementations of {@code Collection}s.
 * 
 * All direct or indirect implementations of {@code Collection} should implement
 * at least two constructors. One with no parameters which creates an empty
 ...
 * {@code Collection} cannot be forced to implement these two constructors but
 * at least all implementations under {@code java.util} do.
 * 
 ...
 * {@code Exception} in cases where the requested operation would not change the
 * collection. In these cases it's up to the implementation whether it throws an
...
public interface Collection<E> extends Iterable<E> {
	...
	/**
	 * Attempts to add {@code object} to the contents of this {@code Collection}
	 * (optional).
	 * 
	 ...
	 * contents of this {@code Collection} (optional). If the passed
	 * {@code Collection} is changed during the process of adding elements to
	 * this {@code Collection}, the behavior is not defined.
	 * 
	 * @param collection
	 ...
	 * Returns {@code true} if and only if at least one element {@code elem} in
	 * this {@code Collection} meets following requirement:
	 ...
	 * the specified {@code Collection}. If an element {@code elem} is contained
	 * several times in the specified {@code Collection}, the method returns
	 * {@code true} even if {@code elem} is contained only once in this
	 * {@code Collection}.
	 * 
	 * @param collection
	 ...
	 * instance of the {@code Collection} has a defined order the elements are
	 ...
	 * 
	 * The array returned does not reflect any changes of the {@code Collection}
	 * . A new array is created even if the underlying data structure is already
	 * an array.
	 * 
	 ...
	 * {@code Collection}. If the specified array is large enough to hold the
	 * elements, the specified array is used, otherwise an array of the same
	 * type is created. If the specified array is used and is larger than this
	 * {@code Collection}, the array element following the {@code Collection}
	 ...
	 *             if the type of an element in this {@code Collection} cannot
