...
/**
 * The {@code TimerTask} class represents a task to run at a specified time. The
 * task may be run once or repeatedly.
 * 
 * @see Timer
...
public abstract class TimerTask implements Runnable {
	 ...
	 * queue. Generally, it returns {@code false} if the call did not prevent a
	 * {@code TimerTask} from running at least once. Subsequent calls have no
	 * effect.
	 * 
