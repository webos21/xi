...
public abstract class Dictionary<K, V> {
	...
	/**
	 * Associate {@code key} with {@code value} in this dictionary. If
	 * {@code key} exists in the dictionary before this call, the old value in
	 * the dictionary is replaced by {@code value}.
	 * 
	 * @param key
	 *            the key to add.
	 * @param value
	 *            the value to add.
	 * @return the old value previously associated with {@code key} or
	 *         {@code null} if {@code key} is new to the dictionary.
	 * @see #elements
	 * @see #get
	 * @see #keys
	 */
