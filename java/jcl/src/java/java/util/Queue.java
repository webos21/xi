 ...
 * while some implementations such as {@code LinkedList} allow it. But
 * {@code null} should not be inserted even in these implementations, since the
 * method {@code poll} returns {@code null} to indicate that there is no element
 * left in the queue.
 * <p>
...
public interface Queue<E> extends Collection<E> {
	 ...
	 * {@code null} if there is no element in the queue.
	 * 
