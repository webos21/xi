...
/**
 * Vector is an implementation of {@link List}, backed by an array and
 * synchronized. All optional operations including adding, removing, and
 ...
 * 
 * <p>
 * This class is equivalent to {@link ArrayList} with synchronized operations.
 * This has a performance cost, and the synchronization is not necessarily
 * meaningful to your application: synchronizing each call to {@code get}, for
 * example, is not equivalent to synchronizing on the list and iterating over it
 * (which is probably what you intended). If you do need very highly concurrent
