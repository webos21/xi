...
/**
 * Holds the results of a successful match of a {@link Pattern} against a given
 * string. The result is divided into groups, with one group for each pair of
 * parentheses in the regular expression and an additional group for the whole
 * regular expression. The start, end, and contents of each group can be
 * queried.
 * 
 * @see Matcher
...
public interface MatchResult {
	...
	/**
	 * Returns the number of groups in the result, which is always equal to the
