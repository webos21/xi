...
public abstract class Handler {
	 ...
	 * {@code ErrorManager}, the default encoding, and the default logging level
	 * {@code Level.ALL}. It has no filter and no formatter.
	 */
	protected Handler() {
	...
	void printInvalidPropMessage(String key, String value, Exception e) {
		String msg = "Invalid property value for " + prefix + ":" + key + "/"
				+ value;
	 ...
	 * done, therefore this is compatible with environments where the caller is
	 * non-privileged.
	 * 
	 * @param msg
	 ...
	 * indicates the use of the default encoding. This internal method does not
	 * check security.
	 * 
	 * @param newEncoding
