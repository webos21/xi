...
public class LogRecord implements Serializable {
	 ...
	 * formatting.
	 * 
	 * @return the associated resource bundle, {@code null} if none is available
	 *         or the message is not localizable.
	 */
	 ...
	 * 
	 * @return the name of the source class of this log record (possiblity
	 *         {@code null})
	 */
	...
	private void readObject(ObjectInputStream in) throws IOException,
		...
		if (major != MAJOR) {
			throw new IOException("Different version " + Byte.valueOf(major)
					+ "." + Byte.valueOf(minor));
		}
