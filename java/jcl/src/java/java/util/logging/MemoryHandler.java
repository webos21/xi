 ...
 * <ul>
 * <li>java.util.logging.MemoryHandler.filter specifies the {@code Filter} class
...
public class MemoryHandler extends Handler {
	...
	public MemoryHandler() {
		...
		try {
			...
			throw new RuntimeException("Cannot load target handler '"
					+ targetName + "'");
		}
		// init size
	 ...
	 * triggering. When a new {@code LogRecord} is put into the internal buffer
	 * and its level is not less than the push level, the push action will be
	 * triggered. Note that set new push level won't trigger push action.
	 * 
	 * @param newLevel
