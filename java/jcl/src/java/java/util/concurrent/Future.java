 ...
 * by the <tt>cancel</tt> method. Additional methods are provided to determine
 ...
 * <tt>Future</tt> for the sake of cancellability but not provide a usable
 * result, you can declare types of the form <tt>Future&lt;?&gt;</tt> and return
 ...
 * For example, the above construction with <tt>submit</tt> could be replaced
 * by:
 * 
 * <pre>
 ...
 * 
 * <p>
 * Memory consistency effects: Actions taken by the asynchronous computation <a
