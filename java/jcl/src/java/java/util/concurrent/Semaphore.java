 ...
 * property (unlike many {@link Lock} implementations), that the
 * &quot;lock&quot; can be released by a thread other than the owner (as
 * semaphores have no notion of ownership). This can be useful in some
 ...
 * method such as {@code release()} <a
 * href="package-summary.html#MemoryVisibility"><i>happen-before</i></a> actions
 * following a successful "acquire" method such as {@code acquire()} in another
 * thread.
 * 
 * @since 1.5
 * @author Doug Lea
