 ...
 * created, the capacity cannot be increased. Attempts to <tt>put</tt> an
 * element into a full queue will result in the operation blocking; attempts to
 * <tt>take</tt> an element from an empty queue will similarly block.
 * 
 * <p>
...
public class ArrayBlockingQueue<E> extends AbstractQueue<E> implements
	...
	/**
	 * Creates an <tt>ArrayBlockingQueue</tt> with the given (fixed) capacity
