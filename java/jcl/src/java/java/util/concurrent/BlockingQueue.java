 ...
 * 
 * <p>
 * A <tt>BlockingQueue</tt> does not accept <tt>null</tt> elements.
 ...
 * 
 * <p>
 * A <tt>BlockingQueue</tt> may be capacity bounded. At any given time it may
 * have a <tt>remainingCapacity</tt> beyond which no additional elements can be
 * <tt>put</tt> without blocking. A <tt>BlockingQueue</tt> without any intrinsic
 ...
 * a thread prior to placing an object into a {@code BlockingQueue} <a
...
public interface BlockingQueue<E> extends Queue<E> {
	 ...
	 * queue, it is generally preferable to use {@link #offer(E) offer}.
	 * 
	 * @param e
	 *            the element to add
