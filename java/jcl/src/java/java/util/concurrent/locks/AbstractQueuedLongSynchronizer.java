...
public abstract class AbstractQueuedLongSynchronizer extends
	...
	/**
	 * Creates a new <tt>AbstractQueuedLongSynchronizer</tt> instance with
	 ...
	 * associated <tt>AbstractQueuedLongSynchronizer</tt>.
	 * 
	 * <p>
	...
	public class ConditionObject implements Condition, java.io.Serializable {
		 ...
		 * {@link AbstractQueuedLongSynchronizer#hasWaiters}.
		 * 
		 ...
		 * {@link AbstractQueuedLongSynchronizer#getWaitQueueLength}.
		 * 
		 * @return the estimated number of waiting threads
		 * @throws IllegalMonitorStateException
		 *             if {@link #isHeldExclusively} returns {@code false}
		 ...
		 * {@link AbstractQueuedLongSynchronizer#getWaitingThreads}.
		 * 
		 * @return the collection of threads
		 * @throws IllegalMonitorStateException
		 *             if {@link #isHeldExclusively} returns {@code false}
	...
	static {
		try {
			stateOffset = unsafe
					.objectFieldOffset(AbstractQueuedLongSynchronizer.class
