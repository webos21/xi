...
/**
 * A <tt>ReadWriteLock</tt> maintains a pair of associated {@link Lock locks},
 ...
 * 
 * <p>
 * All <tt>ReadWriteLock</tt> implementations must guarantee that the memory
 * synchronization effects of <tt>writeLock</tt> operations (as specified in the
 * {@link Lock} interface) also hold with respect to the associated
 * <tt>readLock</tt>. That is, a thread successfully acquiring the read lock
