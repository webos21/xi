 ...
 * <tt>tryAcquire</tt> to return <tt>false</tt> if {@code hasQueuedPredecessors}
...
public abstract class AbstractQueuedSynchronizer extends
	...
	public class ConditionObject implements Condition, java.io.Serializable {
		 ...
		 * @return A value less than or equal to zero if the wait has timed out;
		 *         otherwise an estimate, that is strictly less than the
		 *         <tt>nanosTimeout</tt> argument, of the time still remaining
		 *         when this method returned.
		 * 
		 * @throws InterruptedException
		 *             if the current thread is interrupted (and interruption of
		 *             thread suspension is supported).
		 ...
		 * @return <tt>false</tt> if the deadline has elapsed upon return, else
		 *         <tt>true</tt>.
		 * 
		 * @throws InterruptedException
		 *             if the current thread is interrupted (and interruption of
		 ...
		 * @param unit
		 *            the time unit of the <tt>time</tt> argument.
		 * @return <tt>false</tt> if the waiting time detectably elapsed before
		 *         return from the method, else <tt>true</tt>.
		 * @throws InterruptedException
		 *             if the current thread is interrupted (and interruption of
		 *             thread suspension is supported).
		 */
