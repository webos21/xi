...
public abstract class AtomicReferenceFieldUpdater<T, V> {
	...
	private static final class AtomicReferenceFieldUpdaterImpl<T, V> extends
		...
		AtomicReferenceFieldUpdaterImpl(Class<T> tclass, Class<V> vclass,
				String fieldName) {
			Field field = null;
			...
			try {
				...
				caller = VMStackWalker.getCallingClass2(); // android-changed
				modifiers = field.getModifiers();
				// BEGIN android-added
				SecurityManager smgr = System.getSecurityManager();
				if (smgr != null) {
					int type = Modifier.isPublic(modifiers) ? Member.PUBLIC
							: Member.DECLARED;
			...
			this.cclass = (Modifier.isProtected(modifiers) && caller != tclass) ? caller
					: null;
			this.tclass = tclass;
		...
		void updateCheck(T obj, V update) {
			if (!tclass.isInstance(obj)
					|| (update != null && vclass != null && !vclass
							.isInstance(update)))
				throw new ClassCastException();
			if (cclass != null)
				ensureProtectedAccess(obj);
		...
		public boolean compareAndSet(T obj, V expect, V update) {
			if (obj == null
					|| obj.getClass() != tclass
					|| cclass != null
					|| (update != null && vclass != null && vclass != update
							.getClass()))
		...
		public void set(T obj, V newValue) {
			if (obj == null
					|| obj.getClass() != tclass
					|| cclass != null
					|| (newValue != null && vclass != null && vclass != newValue
							.getClass()))
