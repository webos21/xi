...
public class AtomicMarkableReference<V> {
	...
	public AtomicMarkableReference(V initialRef, boolean initialMark) {
		atomicRef = new AtomicReference<ReferenceBooleanPair<V>>(
				new ReferenceBooleanPair<V>(initialRef, initialMark));
	}
	...
	public boolean weakCompareAndSet(V expectedReference, V newReference,
		...
		return expectedReference == current.reference
				...
				&& ((newReference == current.reference && newMark == current.bit) || atomicRef
	...
	public boolean compareAndSet(V expectedReference, V newReference,
		...
		return expectedReference == current.reference
				&& expectedMark == current.bit
				&& ((newReference == current.reference && newMark == current.bit) || atomicRef
						.compareAndSet(current, new ReferenceBooleanPair<V>(
