 ...
 * fail due to resource exhaustion (causing <tt>OutOfMemoryError</tt>). This
 * class does not permit <tt>null</tt> elements. A priority queue relying on
 ...
 * ordered traversal, consider using <tt>Arrays.sort(pq.toArray())</tt>. Also,
 * method <tt>drainTo</tt> can be used to <em>remove</em> some or all elements
 ...
 * insert a <tt>new FIFOEntry(anEntry)</tt> instead of a plain entry object.
 * 
 * <pre>
...
public class PriorityBlockingQueue<E> extends AbstractQueue<E> implements
	...
	/**
	 * Creates a <tt>PriorityBlockingQueue</tt> containing the elements in the
	 ...
	 * <tt>PriorityBlockingQueue</tt> is not capacity constrained.
	 * 
