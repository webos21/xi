 ...
 * <tt>contains</tt>, <tt>add</tt>, and <tt>remove</tt> operations and their
 * variants. Insertion, removal, and access operations safely execute
 * concurrently by multiple threads. Iterators are <i>weakly consistent</i>,
 * returning elements reflecting the state of the set at some point at or since
 * the creation of the iterator. They do <em>not</em> throw
 ...
 * of the elements. Additionally, the bulk operations <tt>addAll</tt>,
 * <tt>removeAll</tt>, <tt>retainAll</tt>, and <tt>containsAll</tt> are
 * <em>not</em> guaranteed to be performed atomically. For example, an iterator
 * operating concurrently with an <tt>addAll</tt> operation might view only some
 ...
 * <tt>null</tt> elements, because <tt>null</tt> arguments and return values
...
public class ConcurrentSkipListSet<E> extends AbstractSet<E> implements
	 ...
	 *             if the elements in <tt>c</tt> are not {@link Comparable}, or
	...
	/**
	 * Returns a shallow copy of this <tt>ConcurrentSkipListSet</tt> instance.
	 ...
	 * contains no element <tt>e2</tt> such that <tt>e.equals(e2)</tt>. If this
	 ...
	 *         element
	 * @throws ClassCastException
	 *             if <tt>e</tt> cannot be compared with the elements currently
	 *             in this set
	 * @throws NullPointerException
	 *             if the specified element is null
	 */
	 ...
	 * formally, removes an element <tt>e</tt> such that <tt>o.equals(e)</tt>,
	 ...
	 * @throws ClassCastException
	 *             if <tt>o</tt> cannot be compared with the elements currently
	 *             in this set
	 * @throws NullPointerException
	 *             if the specified element is null
	 */
	...
	static {
		try {
			mapOffset = unsafe.objectFieldOffset(ConcurrentSkipListSet.class
					.getDeclaredField("m"));
		} catch (Exception ex) {
			throw new Error(ex);
		}
