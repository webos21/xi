 ...
 * <tt>Executor</tt> is normally used instead of explicitly creating threads.
 * For example, rather than invoking
 * <tt>new Thread(new(RunnableTask())).start()</tt> for each of a set of tasks,
 * you might use:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * However, the <tt>Executor</tt> interface does not strictly require that
 ...
 * </pre>
 * 
 * Many <tt>Executor</tt> implementations impose some sort of limitation on how
 ...
 * </pre>
 * 
 * The <tt>Executor</tt> implementations provided in this package implement
 ...
 * {@code Runnable} object to an {@code Executor} <a
 * href="package-summary.html#MemoryVisibility"><i>happen-before</i></a> its
