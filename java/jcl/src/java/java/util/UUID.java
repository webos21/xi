...
public final class UUID implements Serializable, Comparable<UUID> {
	 ...
	 * <li>3 - Name-based with MD5 hashing UUID (
	 * {@link #nameUUIDFromBytes(byte[])})</li>
	...
	/**
	 * <p>
	 * Compares this UUID to another object for equality. If {@code object} is
	 * not {@code null}, is a UUID instance, and all bits are equal, then
	 * {@code true} is returned.
	 * 
	 * @param object
	 *            the {@code Object} to compare to.
	 * @return {@code true} if this UUID is equal to {@code object} or
	 *         {@code false} if not.
	 */
	@Override
