...
public class Attributes implements Cloneable, Map<Object, Object> {
	...
	/**
	 * Returns a {@code Set} containing all the keys found in this
	 * {@code Attributes}.
	 * 
	...
	/**
	 * Deletes the key/value pair with key {@code key} from this
	 * {@code Attributes}.
	 * 
	 * @param key
	 *            the key to remove.
	...
	/**
	 * Determines if this {@code Attributes} and the parameter
	 * {@code Attributes} are equal. Two {@code Attributes} instances are equal
	 * if they contain the same keys and values.
	 * 
	 * @param obj
