...
public class JarInputStream extends ZipInputStream {
	...
	/**
	 * Returns the {@code Manifest} object associated with this
	 * {@code JarInputStream} or {@code null} if no manifest entry exists.
	 * 
	...
	/**
	 * Returns the next {@code JarEntry} contained in this stream or
	 * {@code null} if no more entries are present.
	 * 
	...
	/**
	 * Returns the next {@code ZipEntry} contained in this stream or
	 * {@code null} if no more entries are present.
	 * 
