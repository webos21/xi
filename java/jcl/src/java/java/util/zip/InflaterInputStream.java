 ...
 * uncompresses data that was compressed using the <i>DEFLATE</i> algorithm (see
 * <a href="http://www.gzip.org/algorithm.txt">specification</a>). Basically it
 * wraps the {@code Inflater} class and takes care of the buffering.
 * 
 * @see Inflater
...
public class InflaterInputStream extends FilterInputStream {
	 ...
	 * {@code InputStream} from which the compressed data is to be read from.
	 * Default settings for the {@code Inflater} and internal buffer are be
	 * used. In particular the Inflater expects a ZLIB header from the input
	 * stream.
	 * 
	 * @param is
