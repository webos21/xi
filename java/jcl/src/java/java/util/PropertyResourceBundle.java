...
/**
 * {@code PropertyResourceBundle} loads resources from an {@code InputStream}.
 * All resources are Strings. The resources must be of the form
 * {@code key=value}, one resource per line (see Properties).
 * 
 * @see ResourceBundle
 * @see Properties
 * @since 1.1
