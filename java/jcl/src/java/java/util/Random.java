...
public class Random implements Serializable {
	...
	/**
	 * Constructs a random generator with an initial state that is unlikely to
	 * be duplicated by a subsequent instantiation.
	 * 
	 * <p>
	 * The initial state (that is, the seed) is <i>partially</i> based on the
	 * current time of day in milliseconds.
	 * </p>
	 * 
	 * @see #setSeed
	 */
	 ...
	 * state. Equivalent to {@code Random r = new Random(); r.setSeed(seed);}.
	 * 
	 * @param seed
	...
	/**
	 * Returns a pseudo-random uniformly distributed {@code double} in the
	 * half-open range [0.0, 1.0).
	 */
	...
	/**
	 * Returns a pseudo-random uniformly distributed {@code float} in the
	 * half-open range [0.0, 1.0).
	 */
	 ...
	 * {@code double} with mean 0.0 and standard deviation 1.0. This method uses
	 * the <i>polar method<i> of G. E. P. Box, M. E. Muller, and G. Marsaglia,
	 * as described by Donald E. Knuth in <i>The Art of Computer Programming,
	 * Volume 2: Seminumerical Algorithms</i>, section 3.4.1, subsection C,
	 * algorithm P.
	 */
