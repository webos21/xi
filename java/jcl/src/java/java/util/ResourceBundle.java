...
public abstract class ResourceBundle {
	...
	private static MissingResourceException missingResourceException(
			String className, String key) {
		String detail = "Can't find resource for bundle '" + className
				+ "', key '" + key + "'";
	...
	public static class Control {
		...
		/**
		 * Returns a control according to {@code formats} whose fallback locale
		 * is null.
		 */
		...
		/**
		 * Returns the time to live of the ResourceBundle {@code baseName} in
		 * {@code locale}, default is TTL_NO_EXPIRATION_CONTROL.
		 */
