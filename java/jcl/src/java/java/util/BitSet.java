...
public class BitSet implements Serializable, Cloneable {
	 ...
	 * @return {@code true} if the bit at {@code index} is set, {@code false}
	 *         otherwise.
	...
	/**
	 * Retrieves the bits starting from {@code fromIndex} to {@code toIndex} and
	 * returns back a new bitset made of these bits. Grows the {@code BitSet} if
	 * {@code toIndex &gt; size}.
	 * 
	 * @param fromIndex
	...
	/**
	 * Sets the bits starting from {@code fromIndex} to {@code toIndex}. Grows
	 * the {@code BitSet} if {@code toIndex > size}.
	 * 
	 * @param fromIndex
	 *            inclusive beginning position.
	 * @param toIndex
	...
	/**
	 * Sets the bits starting from {@code fromIndex} to {@code toIndex} to the
	 * given {@code val}. Grows the {@code BitSet} if {@code toIndex > size}.
	 * 
	 * @param fromIndex
	 *            inclusive beginning position.
	 * @param toIndex
	...
	/**
	 * Clears the bits starting from {@code fromIndex} to {@code toIndex}. Grows
	 * the {@code BitSet} if {@code toIndex > size}.
	 * 
	 * @param fromIndex
	 *            inclusive beginning position.
	...
	/**
	 * Flips the bits starting from {@code fromIndex} to {@code toIndex}. Grows
	 * the {@code BitSet} if {@code toIndex > size}.
	 * 
	 * @param fromIndex
	 *            inclusive beginning position.
