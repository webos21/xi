...
public final class PropertyPermission extends BasicPermission {
	 ...
	 * the <em>same</em> object using a class specific comparison. In this case,
	 * the receiver must be a {@code PropertyPermission} for the same property
	 * as the argument, and must have the same actions. If {@code o} is a
	 * permission that is not a {@code PropertyPermission}, this method may
	 * throw a {@code ClassCastException}.
	 * 
	 * @param o
	 *            the {@code Object} to compare with this {@code Object}.
	 * @return {@code true} if the {@code Object} is the same as this
	 ...
	 * this class. Returns {@code null} if any {@code PermissionCollection} can
	 * be used.
	 * 
