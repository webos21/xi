...
public interface List<E> extends Collection<E> {
	 ...
	 * in this {@code List}. The objects are added in the order they are
	 ...
	 * @return true if this {@code List} has been modified through the
	...
	/**
	 * Returns an iterator on the elements of this {@code List}. The elements
	 * are iterated in the same order as they occur in the {@code List}.
	 * 
	...
	/**
	 * Returns a {@code List} iterator on the elements of this {@code List}. The
	...
	/**
	 * Returns a list iterator on the elements of this {@code List}. The
	 * elements are iterated in the same order as they occur in the {@code List}
	...
	/**
	 * Removes all occurrences in this {@code List} of each object in the
	 * specified collection.
	 * 
	 * @param collection
	...
	/**
	 * Replaces the element at the specified location in this {@code List} with
	...
	/**
	 * Returns a {@code List} of the specified portion of this {@code List} from
	 * the given start index to the end index minus one. The returned
	 * {@code List} is backed by this {@code List} so changes to it are
