 ...
 * Yaroslavskiy, Jon Bentley, and Joshua Bloch. The algorithm offers O(n log(n))
...
final class DualPivotQuicksort {
	 ...
	 * counting sort is used in preference to Quicksort.
	 */
	 ...
	 * range to be sorted is empty (and the call is a no-op).
	 * 
	 * @param a
	 *            the array to be sorted
	 * @param fromIndex
	...
	/**
	 * Sorts the specified range of the array into ascending order. This method
	 * differs from the public {@code sort} method in that the {@code right}
	 * index is inclusive, and it does no range checking on {@code left} or
	 * {@code right}.
	 * 
	 * @param a
	 *            the array to be sorted
	...
	private static void dualPivotQuicksort(int[] a, int left, int right) {
		 ...
		 * 
		 * The pivots are stored in local variables, and the first and the last
		 * of the elements to be sorted are moved to the locations formerly
		 * occupied by the pivots. When partitioning is complete, the pivots are
		 * swapped back into their final positions, and excluded from subsequent
		 * sorting.
		 */
		int pivot1 = ae2;
		a[e2] = a[left];
		...
		if (pivotsDiffer) {
			...
			/*
			 * Partition degenerates to the traditional 3-way, or
		...
		/*
		 * If pivot1 == pivot2, all elements from center part are equal and,
		...
		/*
		 * If center part is too large (comprises > 2/3 of the array), swap
	...
	/**
	 * Sorts the specified range of the array into ascending order. The sort is
	 * done in three phases to avoid expensive comparisons in the inner loop.
	 * The comparisons would be expensive due to anomalies associated with
	 * negative zero {@code -0.0f} and {@code Float.NaN}.
	 * 
	 * @param a
	 *            the array to be sorted
	 * @param left
	...
	/**
	 * Returns the index of some zero element in the specified range via binary
	 * search. The range is assumed to be sorted, and must contain at least one
	 * zero.
	 * 
	 * @param a
	...
	/**
	 * Sorts the specified range of the array into ascending order. This method
	 * differs from the public {@code sort} method in three ways: {@code right}
	 * index is inclusive, it does no range checking on {@code left} or
	 * {@code right}, and it does not handle negative zeros or NaNs in the
	 * array.
	 * 
	 * @param a
	 *            the array to be sorted, which must not contain -0.0f or NaN
	 * @param left
	 *            the index of the first element, inclusive, to be sorted
	 * @param right
	 *            the index of the last element, inclusive, to be sorted
	 ...
	 * done in three phases to avoid expensive comparisons in the inner loop.
	 * The comparisons would be expensive due to anomalies associated with
	 * negative zero {@code -0.0d} and {@code Double.NaN}.
	 * 
	 * @param a
	 *            the array to be sorted
	 * @param left
	 ...
	 * 
	 * @param a
	 *            the array to be sorted, which must not contain -0.0d and NaN
	 * @param left
	 *            the index of the first element, inclusive, to be sorted
	 * @param right
	 *            the index of the last element, inclusive, to be sorted
