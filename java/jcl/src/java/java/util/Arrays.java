...
public class Arrays {
	 ...
	 * preferable implementation for sorting arrays of comparbles if it offers
	 ...
	 * private static void swap(int a, int b, Object[] arr) { ... } private
	 * static void mergeSort(Object[] in, Object[] out, int start, int end) {
	 * ... } private static void mergeSort(Object[] in, Object[] out, int start,
	 * int end, Comparator c) { ... } private static int find(Object[] arr,
	 * Comparable val, int bnd, int l, int r) { ... } private static int
	 * find(Object[] arr, Object val, int bnd, int l, int r, Comparator c) { ...
	 * } private static int medChar(int a, int b, int c, String[] arr, int id) {
	 * ... } private static int charAt(String str, int i) { ... } private static
	 * void copySwap(Object[] src, int from, Object[] dst, int to, int len) {
	 * ... } private static void stableStringSort(String[] arr, int start, int
	 * end) { ... } private static void stableStringSort(String[] arr, String[]
	 * src, String[] dst, int start, int end, int chId) { ... }
	 */
	// END android-removed
