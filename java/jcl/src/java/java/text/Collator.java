 ...
 * 	System.out
 * 			.println(&quot;\u00e0\u0325 is not equal to a\u0325\u0300 without decomposition&quot;);
 * 	myCollator.setDecomposition(Collator.CANONICAL_DECOMPOSITION);
 * 	if (myCollator.compare(&quot;\u00e0\u0325&quot;, &quot;a\u0325\u0300&quot;) != 0) {
 * 		System.out
 * 				.println(&quot;Error: \u00e0\u0325 should be equal to a\u0325\u0300 with decomposition&quot;);
 * 	} else {
 * 		System.out
 * 				.println(&quot;\u00e0\u0325 is equal to a\u0325\u0300 with decomposition&quot;);
 * 	}
 * } else {
 * 	System.out
 * 			.println(&quot;Error: \u00e0\u0325 should be not equal to a\u0325\u0300 without decomposition&quot;);
 * }
 * </pre>
 * 
 * </blockquote>
...
public abstract class Collator implements Comparator<Object>, Cloneable {
	...
	protected Collator() {
		super();
		// BEGIN android-added
		icuColl = com.ibm.icu4jni.text.Collator
				.getInstance(Locale.getDefault());
		// END android-added
	}

	/**
	 * Returns a new collator with the same decomposition mode and strength
	...
	public Object clone() {
		try {
			...
			clone.icuColl = (com.ibm.icu4jni.text.Collator) this.icuColl
					.clone();
			return clone;
	...
	/**
	 * Returns a {@code Collator} instance which is appropriate for the user's
	 * default {@code Locale}. See "<a href="../util/Locale.html#default_locale
	...
	/**
	 * Returns a {@code Collator} instance which is appropriate for
	 * {@code locale}.
	 */
	public static Collator getInstance(Locale locale) {
		...
		return new RuleBasedCollator(
				com.ibm.icu4jni.text.Collator.getInstance(locale));
	}
