...
public class ChoiceFormat extends NumberFormat {
	 ...
	 * @param formats
	 *            the strings associated with the ranges defined through
	 *            {@code limits}. The lower bound of the associated range is at
	 *            the same index as the string.
	 */
	 ...
	 * 
	 * @return the array of doubles which make up the limits of this
	 *         {@code ChoiceFormat}.
	 */
	 ...
	 *            {@code string} from where to start parsing. See the
	 *            <em>Returns</em> section for a description of the output
	 *            values.
	 ...
	 * is selected where {@code i} fulfills {@code limits[i] <= d < limits[i+1]}
	 * .
	 * <p>
	 * The length of the {@code limits} and {@code formats} arrays must be the
	 * same.
