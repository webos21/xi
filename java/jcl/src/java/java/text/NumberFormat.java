 ...
 * </blockquote>
 * <p>
 * You can also use a {@code NumberFormat} to parse numbers: <blockquote>
 * 
 * <pre>
 ...
 * 
 * <p>
 * Use {@code #getInstance} or {@code #getNumberInstance} to get the default
 * number format. Use {@link #getIntegerInstance} to get an integer number
 * format, {@link #getCurrencyInstance} to get the currency number format, and
 ...
 * leaves the parse position just after '6'); if set to {@code false}, "3456.78"
 * is parsed as 3456.78 (and leaves the parse position just after '8'). This is
...
public abstract class NumberFormat extends Format {
	...
	/**
	 * Compares the specified object to this number format and indicates if they
	 * are equal. In order to be equal, {@code object} must be an instance of
	 * {@code NumberFormat} with the same pattern and properties.
	 * 
	 * @param object
	 ...
	 * <p>
	 * The number must be a subclass of {@code Number}. Instances of
	 * {@code Byte}, {@code Short}, {@code Integer}, and {@code Long} have
	 * {@code Number.longValue} invoked, as do instances of {@code BigInteger}
	 * where {@code BigInteger.bitLength} returns <i>less than</i> 64. All other
	...
	/**
	 * Returns an array of locales for which custom {@code NumberFormat}
	...
	public static NumberFormat getIntegerInstance(Locale locale) {
		NumberFormat result = getInstance(
				LocaleData.get(locale).integerPattern, locale);
	...
	/**
	 * Returns a {@code NumberFormat} for formatting and parsing numbers for the
	 * user's default locale. See "<a href="../util/Locale.html#default_locale
	 * ">Be wary of the default locale</a>".
	 * 
	 * @return a {@code NumberFormat} for handling {@code Number} objects.
	 */
	 ...
	 * values for the user's default locale. See
	 * "<a href="../util/Locale.html#default_locale
	 * ">Be wary of the default locale</a>".
	 * 
	 * <p>
	 * The {@code NumberFormat} returned by this method should only be used to
	 * format floating-point numbers typically between 0 and 1 (with 1 being
	 * 100%). A value such as 0.53 will be treated as 53%, but 53.0 (or the
	 * integer 53) will be treated as 5,300%, which is rarely what you intended.
	 */
	...
	private void readObject(ObjectInputStream stream) throws IOException,
		...
		if (minimumIntegerDigits > maximumIntegerDigits
			...
			throw new InvalidObjectException(
					"min digits greater than max digits");
		}
	...
	/**
	 * Returns the {@code RoundingMode} used by this {@code NumberFormat}. The
	 * default implementation in {@code NumberFormat} throws
	 * {@code UnsupportedOperationException}. Subclasses for which a rounding
	...
	/**
	 * Sets the {@code RoundingMode} used by this {@code NumberFormat}. The
	 * default implementation in {@code NumberFormat} throws
	 * {@code UnsupportedOperationException}. Subclasses for which a rounding
	 * mode is meaningful are expected to override this method.
	 * 
