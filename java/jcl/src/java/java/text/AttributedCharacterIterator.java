...
/**
 * Extends the {@link CharacterIterator} interface, adding support for iterating
 * over attributes and not only characters. An
...
public interface AttributedCharacterIterator extends CharacterIterator {
	...
	public static class Attribute implements Serializable {
		 ...
		 * used. The value objects are of type {@code Annotation} which contain
		 * a {@code String}.
		 */
		...
		/**
		 * Calculates the hash code for objects of type {@code Attribute}. It is
		 * defined final so all sub types calculate their hash code identically.
		 * 
	 ...
	 * {@code AttributedCharacterIterator}. An empty set is returned if no
