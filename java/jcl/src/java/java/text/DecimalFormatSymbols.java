...
public class DecimalFormatSymbols implements Cloneable, Serializable {
	 ...
	 * ">Be wary of the default locale</a>". Best practice is to create a
	 * {@code DecimalFormat} and then to get the {@code DecimalFormatSymbols}
	 * from that object by calling
	 ...
	 * specified Locale. See "<a href="../util/Locale.html#default_locale
	 * ">Be wary of the default locale</a>". Best practice is to create a
	 * {@code DecimalFormat} and then to get the {@code DecimalFormatSymbols}
	 * from that object by calling
	 * {@link DecimalFormat#getDecimalFormatSymbols()}.
	...
	/**
	 * Returns a new {@code DecimalFormatSymbols} instance for the user's
	...
	/**
	 * Returns an array of locales for which custom {@code DecimalFormatSymbols}
	...
	public boolean equals(Object object) {
		...
		return currency.equals(obj.currency)
				...
				&& perMill == obj.perMill && percent == obj.percent
				&& zeroDigit == obj.zeroDigit;
	}

	@Override
	public String toString() {
		return getClass().getName() + "[currency=" + currency
				+ ",currencySymbol=" + currencySymbol + ",decimalSeparator="
				+ decimalSeparator + ",digit=" + digit + ",exponentSeparator="
				+ exponentSeparator + ",groupingSeparator=" + groupingSeparator
				+ ",infinity=" + infinity + ",intlCurrencySymbol="
				+ intlCurrencySymbol + ",minusSign=" + minusSign
				+ ",monetarySeparator=" + monetarySeparator + ",NaN=" + NaN
				+ ",patternSeparator=" + patternSeparator + ",perMill="
				+ perMill + ",percent=" + percent + ",zeroDigit=" + zeroDigit
				+ "]";
	}
	...
	/*
	 * Returns the string used to separate mantissa and exponent. Typically "E",
	 * as in "1.2E3".
	 * 
	 * @since 1.6
	 */
	...
	/**
	 * Sets the string used to separate mantissa and exponent. Typically "E", as
	 * in "1.2E3".
	 * 
	 * @since 1.6
	 */
	...
	private void readObject(ObjectInputStream stream) throws IOException,
		...
		final int serialVersionOnStream = fields
				.get("serialVersionOnStream", 0);
