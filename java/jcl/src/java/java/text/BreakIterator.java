 ...
 * {@link CharacterIterator}, which makes it possible to use
 * {@code BreakIterator} to analyze text in any text-storage vehicle that
 * provides a {@code CharacterIterator} interface.
 * <p>
 ...
 * </blockquote>
 * <p>
 * Print the first element: <blockquote>
 * 
 * <pre>
 ...
 * </blockquote>
 * <p>
 * Print the last element: <blockquote>
 * 
 * <pre>
...
public abstract class BreakIterator implements Cloneable {
	...
	/**
	 * Returns an array of locales for which custom {@code BreakIterator}
	 ...
	 * characters using the user's default locale. See
	 * "<a href="../util/Locale.html
	 * #default_locale">Be wary of the default locale</a>".
	 * 
	...
	/**
	 * Returns a new instance of {{@code BreakIterator} to iterate over line
	 * breaks using the user's default locale. See
	 * "<a href="../util/Locale.html#
	 * default_locale">Be wary of the default locale</a>".
	 * 
	 * @return a new instance of {@code BreakIterator} using the default locale.
	...
	/**
	 * Returns a new instance of {@code BreakIterator} to iterate over
	 * sentence-breaks using the default locale. See
	 * "<a href="../util/Locale.html
	 * #default_locale">Be wary of the default locale</a>".
	 * 
	 * @return a new instance of {@code BreakIterator} using the default locale.
	...
	/**
	 * Returns a new instance of {@code BreakIterator} to iterate over
	 * word-breaks using the default locale. See
	 ...
	 * @return {@code true} if the given offset is a boundary position;
	 ...
	 * current position and returns that position. Returns {@code DONE} if no
	 * boundary was found before the current position.
	 * 
	 * @return the position of last boundary.
	 */
