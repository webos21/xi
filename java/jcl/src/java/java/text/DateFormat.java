 ...
 * {@code getDateInstance}: <blockquote>
 * 
 * <pre>
 ...
 * </blockquote>
 * <p>
 * {@code DateFormat} can also be used to parse strings: <blockquote>
 * 
 * <pre>
...
public abstract class DateFormat extends Format {
	 ...
	 * to the {@link Calendar#HOUR} field.
	 */
	...
	/**
	 * Returns a {@code DateFormat} instance for formatting and parsing dates in
	 * the specified style for the user's default locale. See
	 * "<a href="../util/Locale
	 ...
	 * dates and time values in the manner appropriate for the user's default
	...
	public final static DateFormat getDateTimeInstance(int dateStyle,
		...
		String pattern = localeData.getDateFormat(dateStyle) + " "
	...
	/**
	 * Returns a {@code DateFormat} instance for formatting and parsing time
	 * values in the specified style for the user's default locale. See
	 * "<a href="
	 * ../util/Locale.html#default_locale">Be wary of the default locale</a>".
	 * 
	 * @param style
	 *            one of SHORT, MEDIUM, LONG, FULL, or DEFAULT.
	 * @return the {@code DateFormat} instance for {@code style} and the default
	 ...
	 * {@link SimpleDateFormat#formatToCharacterIterator(Object)} method
	 * returns.
	 * <p>
	...
	public static class Field extends Format.Field {
		...
		protected Field(String fieldName, int calendarField) {
			...
			if (calendarField != -1
					&& table.get(Integer.valueOf(calendarField)) == null) {
		...
		protected Object readResolve() throws InvalidObjectException {
			...
			if (calendarField != -1) {
				try {
					...
					if (result != null
							&& this.getName().equals(result.getName())) {
						return result;
					}
