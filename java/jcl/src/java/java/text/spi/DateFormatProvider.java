...
public abstract class DateFormatProvider extends LocaleServiceProvider {
	...
	/**
	 * Returns an instance of {@code DateFormat} that formats times in the given
	...
	/**
	 * Returns an instance of {@code DateFormat} that formats dates in the given
	 * style for the given locale.
	 * 
	 * @param style
	...
	/**
	 * Returns an instance of {@code DateFormat} that formats dates and times in
	 * the given style for the given locale.
	 * 
	 * @param dateStyle
	 *            the given date formatting style.
	 * @param timeStyle
