...
public final class CollationElementIterator {
	 ...
	 * and {@code previous()} when the end or the beginning of the source string
	 * has been reached, and there are no more valid collation elements to
	 * return.
	 */
	...
	CollationElementIterator(
			com.ibm.icu4jni.text.CollationElementIterator iterator) {
	 ...
	 * <li>The length of the source string, if iteration has reached the end.</li>
	 * </ul>
	 * 
	 ...
	 * 
	 * @return the next collation element or {@code NULLORDER} if the end of the
	 ...
	 * 
	 * @return the previous collation element, or {@code NULLORDER} when the
	 *         start of the iteration has been reached.
	 */
	public int previous() {
	...
	public static final int primaryOrder(int order) {
		return com.ibm.icu4jni.text.CollationElementIterator
				.primaryOrder(order);
	}
