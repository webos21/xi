 ...
 * an already existing server-socket, nor can a {@link java.net.SocketImpl} be
 * assigned.
 * <p>
 * A server-socket channel is open but not bound when created by the
 * {@code open()} method. Calling {@code accept} before bound will cause a
...
public abstract class ServerSocketChannel extends AbstractSelectableChannel {
	 ...
	 * {@code accept()} method of the {@link ServerSocket} class.
	 * 
