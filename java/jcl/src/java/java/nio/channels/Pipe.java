...
/**
 * A pipe contains two channels, forming a unidirectional pipe. One is the
 * writable sink channel, and the other is the readable source channel. When
 * bytes are written into the writable channel they can be read from the
 * readable channel. Bytes are read in the order in which they were written.
 */
public abstract class Pipe {
	...
	/**
	 * Returns a new pipe from the default {@see
