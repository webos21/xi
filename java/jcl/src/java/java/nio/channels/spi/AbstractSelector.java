...
/**
 * {@code AbstractSelector} is the base implementation class for selectors. It
 * realizes the interruption of selection by {@code begin} and {@code end}. It
 * also holds the cancellation and the deletion of the key set.
 */
public abstract class AbstractSelector extends Selector {
	...
	protected final void begin() {
		...
		if (AbstractInterruptibleChannel.setInterruptAction != null) {
			try {
				AbstractInterruptibleChannel.setInterruptAction.invoke(
						Thread.currentThread(), new Object[] { new Runnable() {
							public void run() {
	...
	protected final void end() {
		...
		if (AbstractInterruptibleChannel.setInterruptAction != null) {
			try {
				AbstractInterruptibleChannel.setInterruptAction.invoke(
						Thread.currentThread(), new Object[] { null });
			} catch (Exception e) {
				throw new RuntimeException(e);
			}
		}
