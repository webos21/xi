 ...
 * bytes.
 * <p>
 * Read operations are synchronous on a {@code ReadableByteChannel}, that is, if
 * a read is already in progress on the channel then subsequent reads will block
 * until the first read completes. It is undefined whether non-read operations
 * will block.
 */
public interface ReadableByteChannel extends Channel {
	 ...
	 * starting at the buffer's current {@link java.nio.Buffer#position()
	 * position}.
	 * <p>
	 ...
	 * the bytes that were read. The buffer's {@link java.nio.Buffer#limit()
