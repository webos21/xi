 ...
 * FileChannel.map}. Once created, the mapping between the byte buffer and the
 * file region remains valid until the byte buffer is garbage collected.
 * <p>
...
public abstract class MappedByteBuffer extends ByteBuffer {
	...
	MappedByteBuffer(PlatformAddress addr, int capacity, int offset,
			MapMode mapMode) {
		super(capacity);
