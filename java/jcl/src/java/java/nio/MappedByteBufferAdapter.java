 ...
 * @hide
 */
public final class MappedByteBufferAdapter extends MappedByteBuffer implements
		DirectBuffer {
	...
	public ByteBuffer asReadOnlyBuffer() {
		MappedByteBufferAdapter buf = new MappedByteBufferAdapter(
				this.wrapped.asReadOnlyBuffer());
	...
	public PlatformAddress getEffectiveAddress() {
		...
		PlatformAddress addr = ((DirectBuffer) this.wrapped)
				.getEffectiveAddress();
