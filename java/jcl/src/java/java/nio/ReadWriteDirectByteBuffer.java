...
final class ReadWriteDirectByteBuffer extends DirectByteBuffer {
	 ...
	 *                If <code>remaining()</code> is less than <code>len</code>
	 * @exception IndexOutOfBoundsException
	 *                If either <code>off</code> or <code>len</code> is invalid
	 ...
	 *            greater than <code>src.length</code>
	 * @param len
	 *            The number of <code>int</code>s to write, must be no less than
	 *            zero and no greater than <code>src.length - off</code>
	 * @return This buffer
	 * @exception BufferOverflowException
	 *                If <code>remaining()</code> is less than <code>len</code>
	 * @exception IndexOutOfBoundsException
