 ...
 * based on it;</li>
 * <li>{@link #wrap(char[]) Wrap} an existing char array to create a new buffer;
 * </li>
 * <li>{@link #wrap(CharSequence) Wrap} an existing char sequence to create a
 * new buffer;</li>
 * <li>Use {@link java.nio.ByteBuffer#asCharBuffer() ByteBuffer.asCharBuffer} to
 * create a char buffer based on a byte buffer.</li>
 * </ul>
 */
public abstract class CharBuffer extends Buffer implements
	 ...
	 * <p>
	 * The remaining chars will be moved to the head of the buffer, starting
	...
	/**
	 * Compare the remaining chars of this buffer to another char buffer's
	 * remaining chars.
	 * 
	 * @param otherBuffer
	 *            another char buffer.
	...
	/**
	 * Writes chars from the given char array, starting from the specified
