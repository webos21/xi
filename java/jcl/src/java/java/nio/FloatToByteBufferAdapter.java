 ...
 * <li>The byte buffer's position and limit are NOT linked with the adapter. The
 * adapter extends Buffer, thus has its own position and limit.</li>
 * </ul>
 * </p>
 */
final class FloatToByteBufferAdapter extends FloatBuffer implements
	...
	public PlatformAddress getEffectiveAddress() {
		if (byteBuffer instanceof DirectBuffer) {
			...
			PlatformAddress addr = ((DirectBuffer) byteBuffer)
					.getEffectiveAddress();
	...
	public FloatBuffer asReadOnlyBuffer() {
		FloatToByteBufferAdapter buf = new FloatToByteBufferAdapter(
