...
public abstract class ByteBuffer extends Buffer implements
	 ...
	 * <p>
	 * The remaining bytes will be moved to the head of the buffer, starting
	 ...
	 * @param off
	 *            the offset of the byte array, must not be negative and not
	 ...
	 * and it's zero position will correspond to this buffer's current position.
