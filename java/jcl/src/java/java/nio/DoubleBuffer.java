 ...
 * buffer;</li>
 * <li>Use {@link java.nio.ByteBuffer#asDoubleBuffer()
 * ByteBuffer.asDoubleBuffer} to create a double buffer based on a byte buffer.</li>
 * </ul>
 */
public abstract class DoubleBuffer extends Buffer implements
	 ...
	 *         equals to {@code other}; a positive value if this is greater than
	 *         {@code other}.
	 ...
	 * {@code other} is not a {@code DoubleBuffer} then {@code false} is
	 * returned.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * This method considers two doubles {@code a} and {@code b} to be equal if
	 * {@code a == b} or if {@code a} and {@code b} are both {@code NaN}. Unlike
	 * {@link Double#equals}, this method considers {@code -0.0} and
