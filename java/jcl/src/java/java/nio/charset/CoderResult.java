 ...
 * result by calling <code>CoderResult.unmappableForLength(int)</code> with the
 * input sequence size indicating the identity of the unmappable character.
 * </ol>
 */
public class CoderResult {
	...
	public static synchronized CoderResult malformedForLength(int length)
		...
		throw new IllegalArgumentException(
				"Length must be greater than 0; was " + length);
	}

	/**
	 * Gets a <code>CoderResult</code> object indicating an unmappable character
	 * error.
	 * 
	 * @param length
	...
	public int length() throws UnsupportedOperationException {
		...
		throw new UnsupportedOperationException("length meaningless for "
				+ toString());
	}
