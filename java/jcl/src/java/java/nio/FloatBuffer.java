...
public abstract class FloatBuffer extends Buffer implements
	 ...
	 * {@code other} is not a {@code FloatBuffer} then {@code false} is
	 * returned.
	 * 
	 * <p>
	 * Two float buffers are equal if their remaining floats are equal.
	 * Position, limit, capacity and mark are not considered.
	 * 
	 * <p>
	 * This method considers two floats {@code a} and {@code b} to be equal if
	 * {@code a == b} or if {@code a} and {@code b} are both {@code NaN}. Unlike
	 * {@link Float#equals}, this method considers {@code -0.0} and {@code +0.0}
	 * to be equal.
	 * 
	 * @param other
