 ...
 * </li>
 * <li>Use {@link java.nio.ByteBuffer#asLongBuffer() ByteBuffer.asLongBuffer} to
 * create a long buffer based on a byte buffer.</li>
 * </ul>
 */
public abstract class LongBuffer extends Buffer implements
	 ...
	 * position zero. Then the position is set to {@code remaining()}; the limit
	 * is set to capacity; the mark is cleared.
	 * 
	 * @return this buffer.
