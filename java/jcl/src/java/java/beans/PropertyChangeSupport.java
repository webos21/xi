...
public class PropertyChangeSupport implements Serializable {
	 ...
	 * was registered to this property. Nothing happens if it was not registered
	 * with this property or if the property name or the listener is null.
	 * 
	 * @param propertyName
	...
	public synchronized void addPropertyChangeListener(String propertyName,
		...
		if ((listener != null) && (propertyName != null)) {
			...
			if (listener instanceof PropertyChangeListenerProxy) {
				...
				listeners.add(new PropertyChangeListenerProxy(proxy
						.getPropertyName(), (PropertyChangeListener) proxy
						.getListener()));
			} else {
