...
public final class CollationKey extends java.text.CollationKey {
	...
	/**
	 * Checks if target object is equal to this object. Target is first casted
	 * to CollationKey and bitwise compared.
	 * 
	 * @param target
	 *            comparison object
	 ...
	 * sparsely over about 32 (up to 63) bytes spaced evenly through the string.
	 * For each byte, multiply the previous hash value by a prime number and add
	 * the new byte in, like a linear congruential random number generator,
	 * producing a pseudo-random deterministic value well distributed over the
	 * output range.
	 * 
