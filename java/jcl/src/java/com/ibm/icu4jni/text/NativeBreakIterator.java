...
public final class NativeBreakIterator implements Cloneable {
	...
	public Object clone() {
		...
		NativeBreakIterator clone = new NativeBreakIterator(cloneAddr,
				this.type);
	...
	public boolean equals(Object object) {
		...
		// TODO: is this sufficient? shouldn't we be checking the underlying
		// rules?
	...
	public void setText(CharacterIterator newText) {
		...
		for (char c = newText.first(); c != CharacterIterator.DONE; c = newText
				.next()) {
			sb.append(c);
		}
	...
	public static NativeBreakIterator getCharacterInstance(Locale where) {
		return new NativeBreakIterator(
				getCharacterInstanceImpl(where.toString()), BI_CHAR_INSTANCE);
	}

	public static NativeBreakIterator getLineInstance(Locale where) {
		return new NativeBreakIterator(getLineInstanceImpl(where.toString()),
				BI_LINE_INSTANCE);
	}

	public static NativeBreakIterator getSentenceInstance(Locale where) {
		return new NativeBreakIterator(
				getSentenceInstanceImpl(where.toString()), BI_SENT_INSTANCE);
	}

	public static NativeBreakIterator getWordInstance(Locale where) {
		return new NativeBreakIterator(getWordInstanceImpl(where.toString()),
				BI_WORD_INSTANCE);
	}
