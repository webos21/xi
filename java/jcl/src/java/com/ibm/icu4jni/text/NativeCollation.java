...
final class NativeCollation {
	 ...
	 * @param collationstrength
	 *            default collation strength
	 * @return new c collator
	 * @internal ICU 2.4
	 */
	static native int openCollatorFromRules(String rules,
			int normalizationmode, int collationstrength);

	/**
	 * Close a C collator Once closed, a UCollatorOld should not be used.
	 * 
	 * @param collatoraddress
	 *            The UCollatorOld to close
	 * @internal ICU 2.4
	 */
	static native void closeCollator(int collatoraddress);

	/**
	 * Compare two strings. The strings will be compared using the normalization
	 * mode and options specified in openCollator or openCollatorFromRules
	 * 
	 * @param collatoraddress
	 *            address of the c collator
	 * @param source
	 *            The source string.
	 * @param target
	 *            The target string.
	 * @return result of the comparison, Collation.EQUAL, Collation.GREATER or
	 *         Collation.LESS
	 * @internal ICU 2.4
	 */
	static native int compare(int collatoraddress, String source, String target);

	/**
	 * Get the normalization mode for this object. The normalization mode
	 * influences how strings are compared.
	 * 
	 * @param collatoraddress
	...
	/**
	 * Set the normalization mode used int this object The normalization mode
	 * influences how strings are compared.
	 * 
	 * @param collatoraddress
	 *            the address of the C collator
	 * @param normalizationmode
	 *            desired normalization mode; one of the values from
	 *            Normalization
	 * @internal ICU 2.4
	 */
	...
	/**
	 * Get the collation rules from a UCollator. The rules will follow the rule
	 * syntax.
	 * 
	 * @param collatoraddress
	 *            the address of the C collator
	...
	/**
	 * Get a sort key for the argument string Sort keys may be compared using
	 * java.util.Arrays.equals
	 * 
	 * @param collatoraddress
	 *            address of the C collator
	 * @param source
	 *            string for key to be generated
	 * @return sort key
	 * @internal ICU 2.4
	 */
	 ...
	 *            address of the C collator
	 * @param type
	 *            type of attribute to be set
	 * @param value
	 *            attribute value
	 * @exception RuntimeException
	 *                when error occurs while setting attribute value
	 * @internal ICU 2.4
	 */
	 ...
	 * @exception RuntimeException
	 *                thrown when error occurs while getting attribute value
	 * @internal ICU 2.4
	 */
	 ...
	 * 
	 * @param collatoraddress
	 *            address of C collator to be cloned
	 * @return address of the new clone
	 * @exception RuntimeException
	 *                thrown when error occurs while cloning
	 * @internal ICU 2.4
	 */
	 ...
	 * 
	 * @param address
	 *            of C collation element iterator to close.
	 * @internal ICU 2.4
	 */
	static native void closeElements(int address);

	/**
	 * Reset the collation elements to their initial state. This will move the
	 * 'cursor' to the beginning of the text.
	 * 
	 * @param address
	 *            of C collation element iterator to reset.
	 * @internal ICU 2.4
	 */
	static native void reset(int address);

	/**
	 * Get the ordering priority of the next collation element in the text. A
	 * single character may contain more than one collation element.
	 * 
	 * @param address
	 *            if C collation elements containing the text.
	 ...
	 * 
	 * @param address
	 *            of the C collation element iterator containing the text.
	 ...
	 * 
	 * @param address
	 *            of the C collation element iterator to be set
	 * @param source
	...
	/**
	 * Get the offset of the current source character. This is an offset into
	 * the text of the character containing the current collation elements.
	 * 
	 * @param address
	 *            of the C collation elements iterator to query.
	...
	/**
	 * Set the offset of the current source character. This is an offset into
	 * the text of the character to be processed.
	 * 
	 * @param address
	 *            of the C collation element iterator to set.
	 * @param offset
	 *            The desired character offset.
	 * @internal ICU 2.4
	 */
