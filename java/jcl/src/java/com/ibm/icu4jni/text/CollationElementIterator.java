...
/**
 * Collation element iterator JNI wrapper. Iterates over the collation elements
 * of a data string. The iterator supports both forward and backwards full
 * iteration, ie if backwards iteration is performed in the midst of a forward
 * iteration, the result is undefined. To perform a backwards iteration in the
 * midst of a forward iteration, reset() has to be called. This will shift the
 * position to either the start or the last character in the data string
 * depending on whether next() is called or previous().
 * 
 * <pre>
...
public final class CollationElementIterator {
	...
	/**
	 * CollationElementIteratorJNI constructor. The only caller of this class
	 * should be RuleBasedCollator.getCollationElementIterator().
	 * 
	 * @param collelemiteratoraddress
