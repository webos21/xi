...
public final class ErrorCode extends Exception {
	...
	/**
	 * In codeset conversion: a sequence that does NOT belong in the codepage
	...
	/**
	 * Array of error code names corresponding to the errorcodes. ie
	 * ERROR_NAMES_[0] = name of U_ZERO_ERROR
	 */
	private static final String ERROR_NAMES_[] = { "U_ZERO_ERROR",
			"U_ILLEGAL_ARGUMENT_ERROR", "U_MISSING_RESOURCE_ERROR",
			"U_INVALID_FORMAT_ERROR", "U_FILE_ACCESS_ERROR",
			"U_INTERNAL_PROGRAM_ERROR", "U_MESSAGE_PARSE_ERROR",
			"U_MEMORY_ALLOCATION_ERROR", "U_INDEX_OUTOFBOUNDS_ERROR",
