...
public class SSLEngineImpl extends SSLEngine {
	 ...
	 * 
	 * @throws SSLException
	 * @see javax.net.ssl.SSLEngine#beginHandshake() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * 
	 * @throws SSLException
	 * @see javax.net.ssl.SSLEngine#closeInbound() method documentation for more
	 *      information
	 */
	@Override
	 ...
	 * 
	 * @see javax.net.ssl.SSLEngine#closeOutbound() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * @see javax.net.ssl.SSLEngine#getDelegatedTask() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#getSupportedProtocols() method documentation
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#getEnabledProtocols() method documentation
	 *      for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#getUseClientMode() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#getNeedClientAuth() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#getWantClientAuth() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#getHandshakeStatus() method documentation
	 *      for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#getSession() method documentation for more
	 *      information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#isInboundDone() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLEngine#isOutboundDone() method documentation for
	 *      more information
	 */
	@Override
	...
	/**
	 * Decodes one complete SSL/TLS record provided in the source buffer. If
	 * decoded record contained application data, this data will be placed in
	 * the destination buffers. For more information about TLS record
	 * fragmentation see TLS v 1 specification
	 * (http://www.ietf.org/rfc/rfc2246.txt) p 6.2.
	 * 
	 * @param src
	 *            source buffer containing SSL/TLS record.
	 * @param dsts
	 *            destination buffers to place received application data.
	...
	public SSLEngineResult unwrap(ByteBuffer src, ByteBuffer[] dsts,
		...
		if ((session == null || engine_was_closed)
				&& (handshakeStatus
						.equals(SSLEngineResult.HandshakeStatus.NEED_WRAP) || handshakeStatus
	...
	/**
	 * Encodes the application data into SSL/TLS record. If handshake status of
	 * the engine differs from NOT_HANDSHAKING the operation can work without
	 * consuming of the source data. For more information about TLS record
	 * fragmentation see TLS v 1 specification
	 * (http://www.ietf.org/rfc/rfc2246.txt) p 6.2.
	 * 
	 * @param srcs
	 *            the source buffers with application data to be encoded into
	 *            SSL/TLS record.
	 * @param offset
	 *            the offset in the destination buffers array pointing to the
	 *            first buffer with the source data.
	 * @param len
	 *            specifies the maximum number of buffers to be procesed.
	 * @param dst
	 *            the destination buffer where encoded data will be placed.
	 * @see javax.net.ssl.SSLEngine#wrap(ByteBuffer[],int,int,ByteBuffer) method
	 *      documentation for more information
	 */
	@Override
	public SSLEngineResult wrap(ByteBuffer[] srcs, int offset, int len,
		...
		if ((session == null || engine_was_closed)
				&& (handshakeStatus
						.equals(SSLEngineResult.HandshakeStatus.NEED_UNWRAP) || handshakeStatus
						.equals(SSLEngineResult.HandshakeStatus.NEED_TASK))) {
			return new SSLEngineResult(getEngineStatus(), handshakeStatus, 0, 0);
		}
		...
		if (alertProtocol.hasAlert()) {
			...
			if (alertProtocol.isFatalAlert()) {
				...
				return new SSLEngineResult(getEngineStatus(),
						getHandshakeStatus(), 0, alert_data.length);
			}
		}

		if (capacity < recordProtocol.getMinRecordSize()) {
			if (logger != null) {
				logger.println("Capacity of the destination(" + capacity
						+ ") < MIN_PACKET_SIZE("
		...
		try {
			if (!handshakeStatus
				...
				if ((capacity < SSLRecordProtocol.MAX_SSL_PACKET_SIZE)
						&& (capacity < recordProtocol.getRecordSize(dataStream
								.available()))) {
					if (logger != null) {
						logger.println("The destination buffer("
								+ capacity
								+ ") can not take the resulting packet("
								+ recordProtocol.getRecordSize(dataStream
										.available()) + ")");
					}
					return new SSLEngineResult(
							SSLEngineResult.Status.BUFFER_OVERFLOW,
				...
				if (remaining_wrapped_data == null) {
					remaining_wrapped_data = recordProtocol.wrap(
							ContentType.APPLICATION_DATA, dataStream);
				}
	...
	private SSLEngineResult.Status getEngineStatus() {
		return (engine_was_closed) ? SSLEngineResult.Status.CLOSED
