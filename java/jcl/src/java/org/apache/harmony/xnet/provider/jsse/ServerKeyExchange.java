...
public class ServerKeyExchange extends Message {
	 ...
	 *            rsa_modulus or dh_p
	 * @param par2
	 *            rsa_exponent or dh_g
	 * @param par3
	 *            dh_Ys for ServerDHParams; should be null for ServerRSAParams
	 * @param hash
	 *            should be null for anonymous SignatureAlgorithm
	 */
	...
	/**
	 * Returns RSAPublicKey generated using ServerRSAParams (rsa_modulus and
	 * rsa_exponent).
	 * 
	 * @return
	 */
