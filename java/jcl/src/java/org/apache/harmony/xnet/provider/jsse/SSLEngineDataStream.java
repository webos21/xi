...
/**
 * This class provides the DataStream functionality implemented over the array
 * of ByteBuffer instances. Among with the data chunks read functionality it
 * provides the info about amount of consumed data. The source ByteBuffer
 * objects can be replaced by other. So one instance of this wrapper can be
 * reused for several data sources.
 */
