...
/**
 * Represents Cipher Suite as defined in TLS 1.0 spec., A.5. The CipherSuite; C.
...
public class CipherSuite {
	...
	private static CipherSuite[] cuitesByCode = { TLS_NULL_WITH_NULL_NULL,
	...
	/**
	 * array of supported cipher suites. Set of supported suites is defined at
	 * the moment provider's start
	 */
	...
	static {
		...
		for (int i = 0; i < cuitesByCode.length; i++) {
			if (cuitesByCode[i].supported) {
				...
				supportedCipherSuiteNames[count] = supportedCipherSuites[count]
						.getName();
				count++;
			}
		}
	...
	/**
	 * Returns CipherSuite based on V2CipherSpec code as described in TLS 1.0
	 * spec., E. Backward Compatibility With SSL
	 * 
	 * @param b1
	 * @param b2
	 * @param b3
