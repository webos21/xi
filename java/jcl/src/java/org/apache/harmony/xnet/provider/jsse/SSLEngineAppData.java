...
/**
 * This class is used to retrieve the application data arrived for the
 * SSLEngine.
 */
public class SSLEngineAppData implements
	...
	/**
	 * Stores received data. The source data is not cloned, just the array
	 * reference is remembered into the buffer field.
	 */
	...
	/**
	 * Places the data from the buffer into the array of destination ByteBuffer
	 * objects.
	 */
