...
/**
 * This is a wrapper input stream for ByteBuffer data source. Among with the
 * read functionality it provides info about number of cunsumed bytes from the
 * source ByteBuffer. The source ByteBuffer object can be reseted. So one
 * instance of this wrapper can be reused for several ByteBuffer data sources.
 */
