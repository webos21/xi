...
/**
 * This class provides input data stream functionality for SSLSocket. It
 * accumulates the application data received by SSL protocol.
 */
public final class SSLSocketInputStream extends InputStream {
	 ...
	 * 
	 * @param owner
	 *            the socket which will provide this input stream to client
	 *            applications.
	 */
	...
	/**
	 * Reads one byte. If there is no data in the underlying buffer, this
	 * operation can block until the data will be available.
	 * 
	 * @return read value.
	 * @throws IOException
	 */
	...
	private class Adapter implements
		...
		/**
		 * Appends the data to the stream. This method could be implemented in
		 * the outer class itself, but it could be insecure.
		 */
