...
public class SSLSocketImpl extends SSLSocket {
	 ...
	 * @param sslParameters
	 *            : SSLParameters
	 * @see javax.net.ssl.SSLSocket#SSLSocket() method documentation for more
	 *      information.
	 */
	 ...
	 * @see javax.net.ssl.SSLSocket#SSLSocket(String,int) method documentation
	 ...
	 * @throws IOException
	 * @throws UnknownHostException
	 * @see javax.net.ssl.SSLSocket#SSLSocket(String,int,InetAddress,int) method
	 *      documentation for more information.
	 */
	protected SSLSocketImpl(String host, int port, InetAddress localHost,
			int localPort, SSLParameters sslParameters) throws IOException,
	 ...
	 * @return
	 * @throws IOException
	 * @see javax.net.ssl.SSLSocket#SSLSocket(InetAddress,int) method
	 *      documentation for more information.
	 */
	...
	protected SSLSocketImpl(InetAddress address, int port,
			InetAddress localAddress, int localPort, SSLParameters sslParameters)
			throws IOException {
	 ...
	 * 
	 * @see javax.net.ssl.SSLSocket#getSupportedCipherSuites() method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getEnabledCipherSuites() method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#setEnabledCipherSuites(String[]) method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getSupportedProtocols() method documentation
	 *      for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getEnabledProtocols() method documentation
	 *      for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#setEnabledProtocols(String[]) method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#setUseClientMode(boolean) method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getUseClientMode() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#setNeedClientAuth(boolean) method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getNeedClientAuth() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#setWantClientAuth(boolean) method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getWantClientAuth() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#setEnableSessionCreation(boolean) method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getEnableSessionCreation() method
	 *      documentation for more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getSession() method documentation for more
	 *      information
	 */
	@Override
	...
	/**
	 * Performs the handshake process over the SSL/TLS connection as described
	 * in rfc 2246, TLS v1 specification http://www.ietf.org/rfc/rfc2246.txt. If
	 * the initial handshake has been already done, this method initiates
	 * rehandshake. This method works according to the specification of
	 * implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#startHandshake() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#getOutputStream() method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see java.net.Socket#connect(SocketAddress) method documentation for more
	 *      information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see java.net.Socket#connect(SocketAddress,int) method documentation for
	 *      more information
	 */
	@Override
	 ...
	 * This method works according to the specification of implemented class.
	 * 
	 * @see javax.net.ssl.SSLSocket#close() method documentation for more
	 *      information
	 */
	@Override
	...
	/**
	 * This method is called by SSLSocketInputStream class when client
	 * application tryes to read application data from the stream, but there is
	 * no data in its underlying buffer.
	 * 
	 * @throws IOException
	 */
	...
	protected void writeAppData(byte[] data, int offset, int len)
		...
		try {
			if (len < SSLRecordProtocol.MAX_DATA_LENGTH) {
				...
				if (len > 0) {
					output.write(recordProtocol.wrap(
							ContentType.APPLICATION_DATA, data, offset, len));
				}
			}
		} catch (AlertException e) {
			// will throw exception
	...
	/*
	 * Performs handshake proccess over this connection. The hanshake process is
	 * dirrected by the handshake status code provided by handshake protocol. If
	 * this status is NEED_WRAP, method retrieves handshake message from
	 * handshake protocol and sends it to another peer. If this status is
	 * NEED_UNWRAP, method receives and processes handshake message from another
	 * peer. Each of this stages (wrap/unwrap) change the state of handshake
	 * protocol and this process is performed until handshake status is
	 * FINISHED. After handshake process is finnished handshake completed event
	 * are sent to the registered listeners. For more information about the
	 * handshake process see TLS v1 specification
	 * (http://www.ietf.org/rfc/rfc2246.txt) p 7.3.
	 */
	private void doHandshake() throws IOException {
		SSLEngineResult.HandshakeStatus status;
		int type;
		try {
			while (!(status = handshakeProtocol.getStatus())
					.equals(SSLEngineResult.HandshakeStatus.FINISHED)) {
				if (logger != null) {
					String s = (status
							.equals(SSLEngineResult.HandshakeStatus.NEED_WRAP)) ? "NEED_WRAP"
							: (status
									.equals(SSLEngineResult.HandshakeStatus.NEED_UNWRAP)) ? "NEED_UNWRAP"
									: "STATUS: OTHER!";
					logger.println("SSLSocketImpl: HS status: " + s + " "
							+ status);
				}
				if (status.equals(SSLEngineResult.HandshakeStatus.NEED_WRAP)) {
					...
					reportFatalAlert(AlertProtocol.INTERNAL_ERROR,
							new SSLException(
									"Handshake passed unexpected status: "
											+ status));
				}
				if (alertProtocol.hasAlert()) {
	 ...
	 */
	private void reportFatalAlert(byte description_code, SSLException reason)
			throws IOException {
