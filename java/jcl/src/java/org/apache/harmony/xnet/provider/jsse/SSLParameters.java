...
/**
 * The instances of this class encapsulate all the info about enabled cipher
 * suites and protocols, as well as the information about client/server mode of
 * ssl socket, whether it require/want client authentication or not, and
 * controls whether new SSL sessions may be established by this socket or not.
 */
public class SSLParameters {
	...
	/**
	 * Initializes the parameters. Naturally this constructor is used in
	 * SSLContextImpl.engineInit method which dirrectly passes its parameters.
	 * In other words this constructor holds all the functionality provided by
	 * SSLContext.init method.
	 * 
	 * @see SSLContext.init(KeyManager,TrustManager,SecureRandom) for more
	 *      information
	 */
	...
	/**
	 * Returns the value indicating if the parameters configured to work in
	 * client mode.
	 */
	...
	/**
	 * Returns the value indicating if the peer with this parameters tuned to
	...
	/**
	 * Allows/disallows the peer holding this parameters to create new SSL
	 * session
	 */
	...
	/**
	 * Returns the value indicating if the peer with this parameters allowed to
	 * cteate new SSL session
	 */
