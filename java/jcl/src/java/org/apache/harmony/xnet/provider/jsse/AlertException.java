...
/**
 * This exception is used to signal that a fatal alert has occurred while
...
public class AlertException extends RuntimeException {
	 ...
	 * 
	 * @param description
	 *            The alert description code from {@link AlertProtocol}
	 * @param reason
	 *            The SSLException to be thrown to application side after alert
	 *            processing (sending the record with alert, shutdown work,
	 *            etc).
	 * @see AlertProtocol
	 */
	...
	/**
	 * Returns the reason of alert. This reason should be rethrown after alert
	 * processing.
	 * 
