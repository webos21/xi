...
/**
 * This abstract class is a base for Record Protocol operating environmet of
...
public abstract class ConnectionState {
	...
	/**
	 * Returns the minimal possible size of the Generic[Stream|Generic]Cipher
	 * structure under this connection state.
	 */
	...
	/**
	 * Returns the minimal upper bound of the content size enclosed into the
	 * Generic[Stream|Generic]Cipher structure of specified size. For stream
	 * ciphers the returned value will be exact value.
	 */
	 ...
	 * 
	 * @param type
	 *            - the ContentType of the provided data
	 * @param fragment
	 *            - the byte array containing the data to be encrypted under the
	 ...
	 *            current connection state.
	 * @param offset
	 *            - the offset from which the data begins with.
	 * @param len
	 *            - the length of the data.
	 */
	protected abstract byte[] encrypt(byte type, byte[] fragment, int offset,
			int len);
	 ...
	 * 
	 * @param type
	 *            - the ContentType of the data to be decrypted.
	 * @param fragment
	 *            - the byte array containing the data to be encrypted under the
	 *            current connection state.
	 */
	 ...
	 *            - the length of the data.
	 */
	protected abstract byte[] decrypt(byte type, byte[] fragment, int offset,
			int len);
	...
	/**
	 * Shutdownes the protocol. It will be impossiblke to use the instance after
