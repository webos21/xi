 ...
 *      TLS_RSA_WITH_RC4_128_SHA TLS_RSA_EXPORT_WITH_RC2_CBC_40_MD5
 *      TLS_RSA_WITH_IDEA_CBC_SHA TLS_RSA_EXPORT_WITH_DES40_CBC_SHA
 ...
 *      IDEA/CBC/NoPadding RC2/CBC/NoPadding RC4 DES/CBC/NoPadding
 *      DES/CBC/NoPadding DESede/CBC/NoPadding
 * 
 *      Also the current JSSE provider implementation uses the following crypto
 *      algorithms:
 * 
 *      Algorithms that MUST be provided by crypto provider: Mac HmacMD5 Mac
 *      HmacSHA1 MessageDigest MD5 MessageDigest SHA-1 CertificateFactory X509
 * 
 *      The cipher suites with RSA key exchange may also require: Cipher RSA
 *      KeyPairGenerator RSA KeyFactory RSA
 * 
 *      The cipher suites with DH key exchange may also require: Signature
 *      NONEwithDSA KeyPairGenerator DiffieHellman or DH KeyFactory
 *      DiffieHellman or DH KeyAgreement DiffieHellman or DH KeyPairGenerator
 *      DiffieHellman or DH
 * 
 *      Trust manager implementation requires: CertPathValidator PKIX
		...
		AccessController.doPrivileged(new PrivilegedAction<Void>() {
			public Void run() {
				...
				put("KeyManagerFactory.X509",
						KeyManagerFactoryImpl.class.getName());
