...
public class FileURLConnection extends URLConnection {
	...
	/**
	 * Creates an instance of <code>FileURLConnection</code> for establishing a
	 * connection to the file pointed by this <code>URL<code>
	 * 
	 * @param url
	 *            The URL this connection is connected to
	 */
	 ...
	 * by this <code>URL</code>. If the file is a directory, it will return that
	 * directory listing as an input stream.
	 * 
	 * @throws IOException
