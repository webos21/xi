...
class OSFileSystem implements IFileSystem {
	...
	private native int lockImpl(int fd, long start, long length, int type,
			boolean wait);
	...
	public boolean lock(int fd, long start, long length, int type,
	...
	private native void unlockImpl(int fd, long start, long length)
			throws IOException;
	 ...
	 */
	public native long read(int fd, byte[] bytes, int offset, int length)
			throws IOException;

	public native long write(int fd, byte[] bytes, int offset, int length)
			throws IOException;

	/*
	 * Scatter/gather calls.
	 */
	public native long readv(int fd, int[] addresses, int[] offsets,
			int[] lengths, int size) throws IOException;

	public native long writev(int fd, int[] addresses, int[] offsets,
			int[] lengths, int size) throws IOException;
	...
	public native long transfer(int fd, FileDescriptor sd, long offset,
			long count) throws IOException;

	public native int ioctlAvailable(FileDescriptor fileDescriptor)
			throws IOException;
}
