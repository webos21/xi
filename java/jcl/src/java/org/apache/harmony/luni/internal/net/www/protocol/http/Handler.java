...
public class Handler extends URLStreamHandler {
	...
	/**
	 * Answers a connection, which is established via the <code>proxy</code>, to
	 * the HTTP server specified by this <code>URL</code>. If the
	...
	protected URLConnection openConnection(URL u, Proxy proxy)
		...
		if (null == u || null == proxy) {
			throw new IllegalArgumentException("url and proxy can not be null");
		}
