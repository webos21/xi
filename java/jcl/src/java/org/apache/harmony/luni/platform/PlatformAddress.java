...
public class PlatformAddress implements Comparable {
	...
	/**
	 * INVALID is the canonical address with an invalid value (i.e. a
	 * non-address).
	 */
	public static final PlatformAddress INVALID = new PlatformAddress(UNKNOWN,
			UNKNOWN);
	...
	public final void setIntArray(int offset, int[] ints, int intsOffset,
	...
	public final void setFloatArray(int offset, float[] floats,
		...
		OSMemory.setFloatArray(osaddr + offset, floats, floatsOffset, length,
				swap);
	}
