...
public class Handler extends URLStreamHandler {
	...
	/**
	 * Parse the <code>string</code>str into <code>URL</code> u which already
	 * have the context properties. The string generally have the following
	 * format: <code><center>/c:/windows/win.ini</center></code>.
	 * 
	 * @param u
