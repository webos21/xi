...
public class Platform {
	...
	private static final IFileSystem FILE_SYSTEM = OSFileSystem
			.getOSFileSystem();
	// by jshwang
	// new BlockGuard.WrappedFileSystem(OSFileSystem.getOSFileSystem());

	private static final INetworkSystem NETWORK_SYSTEM = OSNetworkSystem
			.getOSNetworkSystem();

	// by jshwang
	// new
	// BlockGuard.WrappedNetworkSystem(OSNetworkSystem.getOSNetworkSystem());
