...
/**
 * An <code>HttpConfiguration</code> contains all the details needed to create
 * an http connection and to compare whether or not two connections are the
 * same. An HttpConfiguration will either consist of a
 * <code>Proxy<code> or a port number (<code>int</code>) and host name (
 * <code>String</code>) or all three, depending on whether or not a
 * <code>Proxy</code> is used and the type of <code>Proxy</code> it is.
 * 
 * <code>HttpConfiguration</code> is used as a key by
 * <code>HttpConnectionManager</code> to retrieve <code>HttpConnection</code>s
 * from its connection pool.
 */
public class HttpConfiguration {
	...
	/**
	 * Returns the Proxy for this configuration, or null if a proxy is not used
	 */
	...
	/**
	 * Returns the host name for this configuration, or null if an http Proxy is
	 * used
	 */
