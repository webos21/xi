...
public class DefaultPolicyScanner {
	...
	protected PrincipalEntry readPrincipalEntry(StreamTokenizer st)
		...
		if (st.ttype == '"') {
			...
			handleUnexpectedToken(st,
					"Expected syntax is principal [class_name] \"principal_name\"");
		}
		return pe;
	}
		...
		parsing: while (true) {
			...
			case StreamTokenizer.TT_WORD:
				...
				handleUnexpectedToken(
						st,
						"Expected syntax is permission permission_class_name [\"target_name\"] [, \"action_list\"] [, signedby \"name1,...,nameN\"]");
				break;
	 ...
	 * {@link org.apache.harmony.security.fortress.DefaultPolicy description}for
	 * details.
	 * 
	 * @see org.apache.harmony.security.fortress.DefaultPolicyParser
