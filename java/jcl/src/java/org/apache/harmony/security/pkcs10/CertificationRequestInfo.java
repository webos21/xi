...
/**
 * CertificationRequestInfo ::= SEQUENCE { version Version, subject Name,
 * subjectPublicKeyInfo SubjectPublicKeyInfo, attributes [0] IMPLICIT Attributes
 * }
 * 
 * Version ::= INTEGER
 * 
	...
	public static final ASN1Sequence ASN1 = new ASN1Sequence(new ASN1Type[] {
		...
		protected Object getDecodedObject(BerInputStream in) {
			...
			return new CertificationRequestInfo(
					ASN1Integer.toIntValue(values[0]), (Name) values[1],
					(SubjectPublicKeyInfo) values[2], (List) values[3],
					in.getEncoded());
		}
