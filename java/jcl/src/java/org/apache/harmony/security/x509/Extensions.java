...
public class Extensions {
	...
	private static List SUPPORTED_CRITICAL = Arrays.asList(new String[] {
			"2.5.29.15", "2.5.29.19", "2.5.29.32", "2.5.29.17", "2.5.29.30",
			"2.5.29.36", "2.5.29.37", "2.5.29.54" });
	...
	public static final ASN1Type ASN1 = new ASN1SequenceOf(Extension.ASN1) {
		...
		public Collection getValues(Object object) {
			...
			return (exts.extensions == null) ? new ArrayList()
					: exts.extensions;
		}
	};
}
