...
public class ASN1Integer extends ASN1Primitive {
	...
	/**
	 * Converts decoded ASN.1 Integer to int value. If the object represents an
	 * integer value larger than 32 bits, the high bits will be lost.
	 * 
	 * @param decoded
	 *            a decoded object corresponding to this type
