...
public final class ObjectIdentifier {
	...
	public static void validate(int[] oid) {
		...
		if (oid[0] > 2) {
			...
			throw new IllegalArgumentException(
					"If the first subidentifier has 0 or 1 value the second subidentifier value MUST be less than 40");
		}
	...
	/**
	 * Returns whether the given string is a valid ObjectIdentifier (OID)
	 * representation.
	 * 
	 ...
	 * @param oidString
	 *            - string representation of OID
	 * @return - oid as array of integers or null if the oid string is invalid
	 *         or null and shouldThrow is false
	 * @throws IllegalArgumentException
	 *             - if oid string is invalid or null and shouldThrow is true
	 */
