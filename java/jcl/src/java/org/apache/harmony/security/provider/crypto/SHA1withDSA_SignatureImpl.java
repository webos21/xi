...
public class SHA1withDSA_SignatureImpl extends Signature {
	...
	/**
	 * Initializes this signature object with PrivateKey object passed as
	 * argument to the method.
	 * 
	 * @params privateKey DSAPrivateKey object
	 * @throws InvalidKeyException
	 *             if privateKey is not DSAPrivateKey object
	 */
	...
	/**
	 * Initializes this signature object with PublicKey object passed as
	 * argument to the method.
	 * 
	 * @params publicKey DSAPublicKey object
	 * @throws InvalidKeyException
	 *             if publicKey is not DSAPublicKey object
	 */
	protected void engineInitVerify(PublicKey publicKey)
		...
		if (publicKey == null || !(publicKey instanceof DSAPublicKey)) {
			throw new InvalidKeyException(
					"publicKey is not an instance of DSAPublicKey");
		}
	...
	/**
	 * Returns signature bytes as byte array containing ASN1 representation for
	 * two BigInteger objects which is SEQUENCE of two INTEGERS. Length of
	 * sequence varies from less than 46 to 48.
	 * 
	 * Resets object to the state it was in when previous call to either
	 * "initSign" method was called.
	 * 
	 * @return byte array containing signature in ASN1 representation
	 * @throws SignatureException
	 *             if object's state is not SIGN or signature algorithm cannot
	 *             process data
	 */

	protected byte[] engineSign() throws SignatureException {

		// names of below BigIntegers are the same as they are defined in DSA
		// standard
		BigInteger r = null;
		BigInteger s = null;
		BigInteger k = null;
		...
		// forming signature according algorithm described in chapter 5 of DSA
		// standard
		...
		// forming signature's ASN1 representation which is SEQUENCE of two
		// INTEGERs
		//
		...
		signature = new byte[6 + n1 + n2]; // 48 is max. possible length of
											// signature
	 ...
	 * @throws SignatureException
	 *             if object was not initialized for signing or verifying
	 */
	...
	private boolean checkSignature(byte[] sigBytes, int offset, int length)
		...
		// forming signature according algorithm described in chapter 6 of DSA
		// standard
	 ...
	 * @throws SignatureException
	 *             if object's state is not VERIFY or signature format is not
	 *             ASN1 representation or signature algorithm cannot process
	 *             data
	 */
