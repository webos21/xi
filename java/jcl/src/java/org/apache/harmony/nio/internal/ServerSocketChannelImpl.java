...
public final class ServerSocketChannelImpl extends ServerSocketChannel
	...
	private final ServerSocketAdapter socket = new ServerSocketAdapter(impl,
			this);
	...
	public SocketChannel accept() throws IOException {
		...
		// TODO: pass in the SelectorProvider used to create this
		// ServerSocketChannelImpl?
		// Create an empty socket channel. This will be populated by
		// ServerSocketAdapter.accept.
		SocketChannelImpl result = new SocketChannelImpl(
				SelectorProvider.provider(), false);
	...
	private static class ServerSocketAdapter extends ServerSocket {
		...
		private Socket accept(Socket socket, SocketChannelImpl sockChannel)
				throws IOException {
