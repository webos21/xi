...
public class NamespaceSupport {
	 ...
	 */
	private final static Enumeration EMPTY_ENUMERATION = new Vector()
			.elements();
	 ...
	 * popped another Namespace context, or treated the declarations phase as
	 * complete by processing a prefixed name.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * @param value
	 *            the namespace declaration attribute state. A value of true
	...
	final class Context {
		...
		void setParent(Context parent) {
			...
			uriTable = this.parent.uriTable;
			elementNameTable = this.parent.elementNameTable;
			attributeNameTable = this.parent.attributeNameTable;
