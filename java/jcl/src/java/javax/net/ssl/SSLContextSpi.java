...
public abstract class SSLContextSpi {
	...
	/**
	 * Returns a new SSLParameters instance that includes the default SSL
	 * handshake parameters values including cipher suites, protocols, and
	 * client authentication.
	 * 
	 * <p>
	 * The default implementation returns an SSLParameters with values based an
	 * SSLSocket created from this instances SocketFactory.
	 * 
	 * @since 1.6
	 */
	...
	/**
	 * Returns a new SSLParameters instance that includes all supported cipher
	...
	private javax.net.ssl.SSLParameters createSSLParameters(boolean supported) {
		try {
			...
			throw new UnsupportedOperationException(
					"Could not access supported SSL parameters");
		}
	}
}
