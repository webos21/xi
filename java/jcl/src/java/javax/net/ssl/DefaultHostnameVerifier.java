 ...
 * <p/>
 * The hostname must match either the first CN, or any of the subject-alts. A
...
class DefaultHostnameVerifier implements HostnameVerifier {
	 ...
	 */
	private final static String[] BAD_COUNTRY_2LDS = { "ac", "co", "com", "ed",
	...
	public final void verify(final String host, final String[] cns,
			final String[] subjectAlts, final boolean strictWithSubDomains)
			throws SSLException {
	...
	public static String[] getDNSSubjectAlts(X509Certificate cert) {
		...
		try {
			...
			Logger.getLogger(DefaultHostnameVerifier.class.getName()).log(
					Level.FINE, "Error parsing certificate.", cpe);
		}
		if (c != null) {
			for (List<?> aC : c) {
				List<?> list = aC;
