...
public interface SSLSession {
	 ...
	 * 
	 * @return the list of certificates, ordered from local certificate to CA's
	 *         certificates.
	 */
	 ...
	 * 
	 * @return the list of certificates, ordered from the identity certificate
	 *         to the CA's certificates
