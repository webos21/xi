 ...
 * <p>
 * This is an extended verification option that implementers can provide. It is
 * to be used during a handshake if the URL's hostname does not match the peer's
