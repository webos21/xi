...
public abstract class HttpsURLConnection extends HttpURLConnection {
	...
	/**
	 * Returns the {@code Principal} used to identify the local host during the
	 * handshake.
	 * 
	 * @return the {@code Principal} used to identify the local host during the
	 *         handshake, or {@code null} if none was used.
	 * @throws IllegalStateException
	 *             if no connection has been established yet.
	 */
