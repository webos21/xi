...
public class SSLContext {
	 ...
	 * 
	 * The default SSL context can be set with {@link #setDefault}. If not, one
	 * will be created with {@code SSLContext.getInstance("Default")}, which
	...
	/**
	 * Sets the default SSLContext instance as returned by {@link #getDefault()}
	...
	public static SSLContext getInstance(String protocol, Provider provider)
		...
		synchronized (ENGINE) {
			...
			return new SSLContext((SSLContextSpi) ENGINE.spi, provider,
					protocol);
		}
	}
	...
	/**
	 * Returns the default SSL handshake parameters for SSLSockets created by
	 * this SSLContext.
	 * 
	 * @throws UnsupportedOperationException
	 * @since 1.6
	...
	/**
	 * Returns SSL handshake parameters for SSLSockets that includes all
