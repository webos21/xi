...
/**
 * The result object describing the state of the {@code SSLEngine} produced by
 * the {@code wrap()} and {@code unwrap()} operations.
 */
public class SSLEngineResult {
	...
	public String toString() {
		return "SSLEngineReport: Status = " + status + "  HandshakeStatus = "
				+ handshakeStatus + "\n                 bytesConsumed = "
