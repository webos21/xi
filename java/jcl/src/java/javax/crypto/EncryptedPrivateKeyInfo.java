 ...
 * specified in <a href="http://www.ietf.org/rfc/rfc5208.txt">PKCS #8 -
...
public class EncryptedPrivateKeyInfo {
	 ...
	 * @throws NullPointerException
	 *             if {@code encrAlgName} or {@code encryptedData} is
	 *             {@code null}.
	...
	public EncryptedPrivateKeyInfo(String encrAlgName, byte[] encryptedData)
		...
		System.arraycopy(encryptedData, 0, this.encryptedData, 0,
				encryptedData.length);
		this.algParameters = null;
	}

	/**
	 * Creates an {@code EncryptedPrivateKeyInfo} instance from the encryption
	 ...
	 * @throws NullPointerException
	 *             if {@code algParams} or {@code encryptedData} is {@code null}
	 *             .
	 */
	...
	private static final ASN1SetOf ASN1Attributes = new ASN1SetOf(
			ASN1Any.getInstance());
