...
public abstract class CipherSpi {
	 ...
	 * {@code update} of {@code doFinal} would return, taking into account any
	 * buffered data from previous {@code update} calls and padding.
	 * <p>
	 * The actual output length of the next call to {@code update} or
	 * {@code doFinal} may be smaller than the length returned by this method.
	 * 
	 * @param inputLen
	 ...
	 * provider or random values). Random values will be generated using
	 * {@code random};
	 * <p>
	 ...
	 *             if the input is null, or if {@code inputOffset} and
	 ...
	 * method is not overridden, it throws an
	 ...
	 * If this method is not overridden, it throws an
	 * {@code UnsupportedOperationException}.
	 * 
	 * @param key
