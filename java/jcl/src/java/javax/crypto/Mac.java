...
public class Mac implements Cloneable {
	 ...
	 *            the key to initialize this algorithm.
	 * @throws InvalidKeyException
	 *             if initialization fails because the provided key is
	 *             {@code null}.
	...
	/**
	 * Computes the digest of this MAC based on the data previously specified in
	 * {@link #update} calls and stores the digest in the specified
	 * {@code output} buffer at offset {@code outOffset}.
	 * <p>
	 * This {@code Mac} instance is reverted to its initial state and can be
	 * used to start the next MAC computation with the same parameters or
	 * initialized with different parameters.
	 ...
	 *             digest to be stored, the specified output buffer is
	 *             {@code null}, or the specified offset is negative or past the
	...
	public final void doFinal(byte[] output, int outOffset)
		...
		if (t > (output.length - outOffset)) {
			throw new ShortBufferException("Output buffer is short. Needed "
					+ t + " bytes.");
		}
