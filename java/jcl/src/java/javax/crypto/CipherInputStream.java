 ...
 * decryption is used with a {@code CipherInputStream}, the
 * {@code CipherInputStream} tries to read the data an decrypt them before
 * returning.
 */
public class CipherInputStream extends FilterInputStream {
	...
	/**
	 * Creates a new {@code CipherInputStream} instance for an
	 * {@code InputStream} and a cipher.
	 * 
	 * <p>
	...
	/**
	 * Creates a new {@code CipherInputStream} instance for an
	 * {@code InputStream} without a cipher.
	 * <p>
	...
	public int read() throws IOException {
		if (finished) {
			return ((o_buffer == null) || (index == o_buffer.length)) ? -1
					: o_buffer[index++] & 0xFF;
		}
