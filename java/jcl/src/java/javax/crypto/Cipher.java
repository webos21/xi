...
public class Cipher {
	 ...
	 *             if either cipherSpi is {@code null} or provider is
	 *             {@code null} and {@code cipherSpi} is a {@code NullCipherSpi}
	 *             .
	 */
	...
	public static final Cipher getInstance(String transformation,
		...
		if (p == null) {
			throw new NoSuchProviderException("Provider not available: "
					+ provider);
		}
	...
	private static NoSuchAlgorithmException invalidTransformation(
	 ...
	 * {@code init} methods, the state of the instance is overridden, meaning
	 * that it is equivalent to creating a new instance and calling its
	 * {@code init} method.
	 * 
	 * @param opmode
	 *            the operation this cipher instance should be initialized for
	 *            (one of: {@code ENCRYPT_MODE}, {@code DECRYPT_MODE},
	 ...
	 * <p>
	 * When a cipher instance is initialized by a call to any of the
	 * {@code init} methods, the state of the instance is overridden, means it
	 ...
	 * When a cipher instance is initialized by a call to any of the
	 * {@code init} methods, the state of the instance is overridden, meaning
	 * that it is equivalent to creating a new instance and calling it
	 * {@code init} method.
	 * 
	 * @param opmode
	 *            the operation this cipher instance should be initialized for
	 ...
	 * usage</i> extension field marked as critical, the specified
	 * {@code opmode} has the be enabled for this key, otherwise an
	...
	public final void init(int opmode, Certificate certificate,
		...
		if (certificate instanceof X509Certificate) {
			Set<String> ce = ((X509Certificate) certificate)
	 ...
	 *            {@code SECRET_KEY <code>, <code>PRIVATE_KEY} or
	 *            {@code PUBLIC_KEY})
	 * @return the unwrapped key
	 * @throws InvalidKeyException
	 *             if the {@code wrappedKey} can not be unwrapped to a key of
	 *             type {@code wrappedKeyType} for the
