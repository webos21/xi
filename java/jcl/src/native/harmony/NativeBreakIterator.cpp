...
#include "com_ibm_icu4jni_text_NativeBreakIterator.h"
...
Java_com_ibm_icu4jni_text_NativeBreakIterator_getCharacterInstanceImpl(
		JNIEnv* env, jclass, jstring locale) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_getLineInstanceImpl(JNIEnv* env,
		jclass, jstring locale) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_getSentenceInstanceImpl(
		JNIEnv* env, jclass, jstring locale) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_getWordInstanceImpl(JNIEnv* env,
		jclass, jstring locale) {
...
Java_com_ibm_icu4jni_text_NativeBreakIterator_closeBreakIteratorImpl(JNIEnv*,
		jclass, jint address) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_cloneImpl(JNIEnv* env, jclass,
		jint address) {
	UErrorCode status = U_ZERO_ERROR;
	jint bufferSize = U_BRK_SAFECLONE_BUFFERSIZE;
	UBreakIterator* it = ubrk_safeClone(breakIterator(address), NULL,
			&bufferSize, &status);
	icu4jni_error(env, status);
	return reinterpret_cast<uintptr_t> (it);
}
...
JNIEXPORT void JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_setTextImpl(JNIEnv* env, jclass,
		jint address, jstring javaText) {
...
Java_com_ibm_icu4jni_text_NativeBreakIterator_isBoundaryImpl(JNIEnv*, jclass,
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_nextImpl(JNIEnv*, jclass,
		jint address, jint n) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_precedingImpl(JNIEnv*, jclass,
		jint address, jint offset) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_firstImpl(JNIEnv*, jclass,
		jint address) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_followingImpl(JNIEnv*, jclass,
		jint address, jint offset) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_currentImpl(JNIEnv*, jclass,
		jint address) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_previousImpl(JNIEnv*, jclass,
		jint address) {
...
JNIEXPORT jint JNICALL
Java_com_ibm_icu4jni_text_NativeBreakIterator_lastImpl(JNIEnv*, jclass,
		jint address) {
