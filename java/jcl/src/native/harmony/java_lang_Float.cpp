...
Java_java_lang_Float_floatToIntBits(JNIEnv*, jclass, jfloat val) {
    Float f;
    f.f = val;
...
JNIEXPORT jint JNICALL
Java_java_lang_Float_floatToRawIntBits(JNIEnv*, jclass, jfloat val) {
    Float f;
    f.f = val;
    return f.bits;
}
...
Java_java_lang_Float_intBitsToFloat(JNIEnv*, jclass, jint val) {
    Float f;
    f.bits = val;
    return f.f;
}
