...
Java_java_util_zip_Adler32_updateImpl(JNIEnv* env, jobject, jbyteArray byteArray, int off, int len, jlong crc) {
...
JNIEXPORT jlong JNICALL
Java_java_util_zip_Adler32_updateByteImpl(JNIEnv*, jobject, jint val, jlong crc) {
    Bytef bytefVal = val;
