...
Java_java_lang_Double_doubleToLongBits(JNIEnv*, jclass, jdouble val) {
    Double d;
    d.d = val;
...
JNIEXPORT jlong JNICALL
Java_java_lang_Double_doubleToRawLongBits(JNIEnv*, jclass, jdouble val) {
    Double d;
    d.d = val;
    return d.bits;
}
...
Java_java_lang_Double_longBitsToDouble(JNIEnv*, jclass, jlong val) {
    Double d;
    d.bits = val;
    return d.d;
}
