...
public:
	MatcherAccessor(JNIEnv* env, jint addr, jstring javaInput, bool reset) {
		...
		mUText = utext_openUChars(NULL, (const UChar *) mChars,
				env->GetStringLength(mJavaInput), &mStatus);
		if (mUText == NULL) {
			return;
		}
...
Java_java_util_regex_Matcher_closeImpl(JNIEnv*, jclass, jint addr) {
...
Java_java_util_regex_Matcher_findImpl(JNIEnv* env, jclass, jint addr,
		jstring javaText, jint startIndex, jintArray offsets) {
...
JNIEXPORT jboolean JNICALL
Java_java_util_regex_Matcher_findNextImpl(JNIEnv* env, jclass, jint addr,
		jstring javaText, jintArray offsets) {
	MatcherAccessor matcher(env, addr, javaText, false);
...
Java_java_util_regex_Matcher_groupCountImpl(JNIEnv* env, jclass, jint addr) {
...
JNIEXPORT jboolean JNICALL
Java_java_util_regex_Matcher_hitEndImpl(JNIEnv* env, jclass, jint addr) {
	MatcherAccessor matcher(env, addr);
...
JNIEXPORT jboolean JNICALL
Java_java_util_regex_Matcher_lookingAtImpl(JNIEnv* env, jclass, jint addr,
		jstring javaText, jintArray offsets) {
	MatcherAccessor matcher(env, addr, javaText, false);
...
JNIEXPORT jboolean JNICALL
Java_java_util_regex_Matcher_matchesImpl(JNIEnv* env, jclass, jint addr,
		jstring javaText, jintArray offsets) {
	MatcherAccessor matcher(env, addr, javaText, false);
...
JNIEXPORT jint JNICALL
Java_java_util_regex_Matcher_openImpl(JNIEnv* env, jclass, jint patternAddr) {
	RegexPattern
			* pattern =
					reinterpret_cast<RegexPattern*> (static_cast<uintptr_t> (patternAddr));
...
JNIEXPORT jboolean JNICALL
Java_java_util_regex_Matcher_requireEndImpl(JNIEnv* env, jclass, jint addr) {
	MatcherAccessor matcher(env, addr);
...
JNIEXPORT void JNICALL
Java_java_util_regex_Matcher_setInputImpl(JNIEnv* env, jclass, jint addr,
		jstring javaText, jint start, jint end) {
...
JNIEXPORT void JNICALL
Java_java_util_regex_Matcher_useAnchoringBoundsImpl(JNIEnv* env, jclass,
		jint addr, jboolean value) {
	MatcherAccessor matcher(env, addr);
...
JNIEXPORT void JNICALL
Java_java_util_regex_Matcher_useTransparentBoundsImpl(JNIEnv* env, jclass,
		jint addr, jboolean value) {
	MatcherAccessor matcher(env, addr);
