...
JNIEXPORT jint JNICALL
Java_java_lang_Character_getTypeImpl(JNIEnv*, jclass, jint codePoint) {
...
Java_java_lang_Character_isMirroredImpl(JNIEnv*, jclass, jint codePoint) {
...
JNIEXPORT jboolean JNICALL
Java_java_lang_Character_isDefinedImpl(JNIEnv*, jclass, jint codePoint) {
    return u_isdefined(codePoint);
}

//static jboolean Character_isDigitImpl(JNIEnv*, jclass, jint codePoint) {
JNIEXPORT jboolean JNICALL
Java_java_lang_Character_isDigitImpl(JNIEnv*, jclass, jint codePoint) {
...
JNIEXPORT jboolean JNICALL
Java_java_lang_Character_isUnicodeIdentifierPartImpl(JNIEnv*, jclass, jint codePoint) {
...
JNIEXPORT jint JNICALL
Java_java_lang_Character_toTitleCaseImpl(JNIEnv*, jclass, jint codePoint) {
...
//static jint Character_forNameImpl(JNIEnv* env, jclass, jstring javaBlockName) {
JNIEXPORT jint JNICALL
Java_java_lang_Character_forNameImpl(JNIEnv* env, jclass, jstring javaBlockName) {
