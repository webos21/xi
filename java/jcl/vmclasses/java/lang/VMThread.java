...
class VMThread {
	...
	private static final String UNSUPPORTED_THREAD_METHOD = "Deprecated Thread methods are not supported.";
	...
	void suspend() {
		Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).log(Level.SEVERE,
				UNSUPPORTED_THREAD_METHOD, new UnsupportedOperationException());
	...
	/**
	 * Tell the VM that the thread's name has changed. This is useful for DDMS,
	 * which would otherwise be oblivious to Thread.setName calls.
	 */
