...
public final class VMStackWalker {
	 ...
	 * stack. <code>getClassContext()[0]</code> is the class associated with the
	 * currently executing method, i.e., the method that called
	 ...
	 * expression <code>getClassContext(c)[0]</code> and should return the same
	 * result.
	 * 
	 * <p>
	...
	// by jshwang
	public static native Class getCallingClass2();
	 ...
	 * expression <code>getCallingClass().getClassLoader()</code> and should
	...
	/**
	 * Walk up the stack and return the first non-null class loader. If there
	 * aren't any non-null class loaders on the stack, return null.
	 */
	// by jshwang
