...
#define SYMBOLS_DO(action) \
    ...
    action(pd, "pd"), \
    action(put, "put"), \
    action(osaddr, "osaddr"), /* by jshwang - added */ \
    action(capacity, "capacity"), /* by jshwang - added */ \
    action(effectiveDirectAddress, "effectiveDirectAddress"), /* by jshwang - added */ \
    action(run, "run"), \
    action(cons, "cons"), \
    action(main, "main"), \
    action(data, "data"), \
    action(name, "name"), \
    /*action(root, "root"), by jshwang */ \
    action(root, "mSystem"), /* by jshwang - changed for harmony */ \
    action(exit, "exit"), \
    action(slot, "slot"), \
    action(type, "type"), \
    action(flag, "flag"), \
    ...
    action(getEffectiveAddress, "getEffectiveAddress"), /* by jshwang - added */ \
    action(toLong, "toLong"), /* by jshwang - added */ \
    action(on, "on"), /* by jshwang - added */ \
    \
    ...
    action(org_apache_harmony_nio_internal_DirectBuffer, "org/apache/harmony/nio/internal/DirectBuffer"), /* by jshwang - added */ \
    action(java_nio_ReadWriteDirectByteBuffer, "java/nio/ReadWriteDirectByteBuffer"), /* by jshwang - added */ \
    action(org_apache_harmony_luni_platform_PlatformAddress, "org/apache/harmony/luni/platform/PlatformAddress"), /* by jshwang - added */ \
    action(org_apache_harmony_luni_platform_PlatformAddressFactory, "org/apache/harmony/luni/platform/PlatformAddressFactory"), /* by jshwang - added */ \
    \
    ...
    action(_java_lang_String__java_lang_Class, "(Ljava/lang/String;)Ljava/lang/Class;"), /* by jshwang - added */ \
    action(___org_apache_harmony_luni_platform_PlatformAddress, "()Lorg/apache/harmony/luni/platform/PlatformAddress;"), /* by jshwang - added */ \
    action(_org_apache_harmony_luni_platform_PlatformAddress_I_I__V, "(Lorg/apache/harmony/luni/platform/PlatformAddress;II)V"), /* by jshwang - added */ \
    action(_I___org_apache_harmony_luni_platform_PlatformAddress, "(I)Lorg/apache/harmony/luni/platform/PlatformAddress;")/* by jshwang - added */ 
