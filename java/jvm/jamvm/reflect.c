...
Object *createConstructorObject(MethodBlock *mb) {
    ...
    signature = sig = sysMalloc(xi_strlen(mb->type) + 1);
    xi_strcpy(sig, mb->type);
...
Object *createFieldObject(FieldBlock *fb) {
    ...
    signature = sig = sysMalloc(xi_strlen(fb->type) + 1);
    xi_strcpy(signature, fb->type);
...
Object *getClassInterfaces(Class *class) {
    ...
    xi_mem_copy(ARRAY_DATA(array, Class*), cb->interfaces,
...
Class *findClassFromSignature(char *type_name, Class *class) {
    ...
    name = pntr = sysMalloc(xi_strlen(type_name) + 1);
    xi_strcpy(name, type_name);
        ...
        if((wrapper_class = findSystemClass(wrapper_names[prim_type_no - 1]))
            ...
            if(prim_type_no > PRIM_IDX_FLOAT)
                ...
                if(flags == REF_SRC_FIELD)
                    ...
                    INST_BASE(wrapper, u4)[0] = *(xuintptr*)pntr;
        }
    }
...
u4_o2f: /* ostack -> field */
    *(u4*)dest = *(xuintptr*)src;
    return 1;
u4_f2o: /* field -> ostack */
    *(xuintptr*)dest = *(u4*)src;
    return 1;
u4_f2f: /* field -> field */
    *(u4*)dest = *(u4*)src;
    return 1;
...
i2f_o2f: /* ostack -> field */
    *(float*)dest = (float)(int)*(xuintptr*)src;
    return 1;
...
i2f_f2f: /* field -> field */
    *(float*)dest = (float)*(int*)src;
    return 1;
i2d_so: /* src ostack */
    *(double*)dest = (double)(int)*(xuintptr*)src;
    return 2;
i2d_sf: /* src field */
    *(double*)dest = (double)*(int*)src;
    return 2;
i2j_so: /* src ostack */
    *(long long*)dest = (long long)(int)*(xuintptr*)src;
    return 2;
i2j_sf: /* src field */
