...
#define REF_TYPE(ref)   (((xuintptr)(ref))&REF_MASK)
#define REF_TO_OBJ(ref) ((Object*)(((xuintptr)(ref))&~REF_MASK))
#define OBJ_TO_REF(ref, ref_type) ((jobject)(((xuintptr)(ref))|ref_type))
