...
iconv_t iconv_open (const char* tocode, const char* fromcode)
{
 ...
 // jshwang #include "iconv_open1.h"
// Start of iconv_open1.h
  {
...
// jshwang #include "iconv_open2.h"
// Start of iconv_open2.h
