...
build_tool_cxx    = ${build_tool_dir}/${build_droid_eabi}-c++
build_tool_linker = ${build_tool_dir}/${build_droid_eabi}-c++
...
build_opt_ld      = -g --sysroot=${build_droid_sysroot}
...
# Compile Target
########################
build_xi_src_in   = $(wildcard ${basedir}/src/xibase/src/_all/*.c)
build_xi_src_in  += $(wildcard ${basedir}/src/xibase/src/posix/*.c)
build_xi_src_ex   = 
